...
#pdf(file="figures/global/developed/4.1_CareerStage.pdf", width = 11, height= 7)
...
#pdf(file="figures/global/developed/4.2_FieldofResearch.pdf", width = 11, height= 7)
...
#pdf(file="figures/global/developed/4.3.1_ResearchProportion.pdf", width = 11, height= 7)
...
ggplot(res.plot, aes(percent, fill=ID)) +
  ...
  scale_x_continuous(breaks=seq(0,100,10))+scale_y_continuous(expand=c(0,0), limits=c(0,550),breaks=seq(0,550,50))
...
p1 <- ggplot(xs$Fundamental,aes(percent, fill=time)) +
  ...
  scale_x_continuous(breaks=seq(0,100,10))+scale_y_continuous(expand=c(0,0), limits=c(0,550),breaks=seq(0,550,100))
...
#pdf(file="figures/global/developed/4.3.2_ResearchProportion.pdf", width = 11, height= 7)
...
p2<-ggplot(sum.global, aes(x=Var1, y=Freq, fill=Var1)) + geom_bar(stat='identity')+ 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 800))+annotate('text', 5.4,760, label="(b)", size=5)+geom_text(aes(label=Freq), vjust=-0.5, size=3)
...
#pdf(file="figures/global/developed/4.4a&b_ReasonForFieldChange.pdf", width = 11, height= 7)
...
#pdf(file="figures/global/developed/4.5_ViewFieldChange.pdf", width = 11, height= 7)
...
ggplot(change.view.glb, aes(x=view_change_of_type, y=gender, fill=view_change_of_type)) + geom_bar(stat='identity')+
  ...
  theme(panel.grid.major = element_blank(),legend.text=element_text(size = 9), panel.grid.minor = element_blank())+ labs(x="", y="Number of responses", title="Opinion of change in research type (developed nations)")+geom_text(aes(label=gender), vjust=-0.5, size=3)+scale_y_continuous(expand = c(0, 0), limits = c(0,320))+scale_fill_manual(name='view_change_of_type', values=myColors5)#+annotate('text', 5.4,133, label="(c)", size=5)
...
#pdf(file="figures/global/developed/4.6_LevelsOfPartnership.pdf", width = 11, height= 7)
...
#pdf(file="figures/global/developed/4.7a&b_PartnershipChange&Reason.pdf", width = 11, height= 7)
...
#pdf(file="figures/global/developed/4.8_ViewChangePartnership.pdf", width = 11, height= 7)
...
#pdf(file="figures/global/developed/4.9_NumberGrantApps.pdf", height=7, width =11)
...
#pdf(file="figures/global/developed/4.10_GrantAppSuccess.pdf", height=7, width =11)
...
#pdf(file="figures/global/developed/4.11_ChangeSuccessRate.pdf", height=7, width =11)
...
ggplot(data=success.change, aes(x=level, Freq, fill=type))+ facet_wrap(~type, nrow=3)+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,1110))
...
#pdf(file="figures/global/developed/4.12_ImportancePracticalApplication.pdf", height=7, width =11)
...
ggplot(prac.gbl, aes(Var2, Freq, fill=Var1)) + 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,825))
...
#pdf(file="figures/global/developed/4.13_ImportancePartnersApplication.pdf", height=7, width =11)
...
#pdf(file="figures/global/developed/4.14_DistributionFunding.pdf", height=7, width =11)
...
#pdf(file="figures/global/developed/4.15_PerceivedImportanceFundamentalGovernment.pdf", height=7, width =11)
...
#pdf(file="figures/global/developed/4.16_PerceivedChangeResearchPriorityGovernment.pdf", height=7, width =11)
...
ggplot(data=per.change, aes(x=what.type, higher.priority, fill=what.type))+
  ...
  geom_text(aes(label=higher.priority, vjust=-0.5), size=3) +scale_y_continuous(expand = c(0, 0), limits = c(0,2200))+ colScale
...
#pdf(file="figures/global/developed/4.17_AnticipatedChangeFunding.pdf", height=7, width =11)
...
ggplot(data=availability.gbl, aes(x=level, Freq, fill=what.type))+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,890), breaks = seq(0,880,100))
...
#pdf(file="figures/global/developed/4.18_EffectNextGeneration.pdf", height=7, width =11)
