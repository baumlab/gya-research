...
<!-- Import global data, calculate sample sizes -->
```{r, echo=FALSE, hide=TRUE, warning=FALSE, message=FALSE}
## CHANGE WD FOR YOUR LOCAL MACHINE BEFORE KNITTING
...
ggplot(data=gender.perceive, aes(x=Var1, y=Freq, fill=Var2)) + geom_bar(stat='identity', position='dodge')+ labs(x="", y="Percentage of responses", fill="")+theme(axis.text.x = element_text(angle=90, vjust=0.5))+theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())
