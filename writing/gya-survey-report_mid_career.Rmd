...
#pdf(file="figures/mid_career/4.3.1_ResearchProportion.pdf", width = 11, height= 7)
...
#pdf(file="figures/mid_career/4.4a&b_ReasonForFieldChange.pdf", width = 11, height= 7)
...
#pdf(file="figures/mid_career/4.5_ViewFieldChange.pdf", width = 11, height= 7)
...
#pdf(file="figures/mid_career/4.6_LevelsOfPartnership.pdf", width = 11, height= 7)
...
#pdf(file="figures/mid_career/4.7a&b_PartnershipChange&Reason.pdf", width = 11, height= 7)
...
view<-data.frame(table(mid.mid$view_change_partnership))
view<-view[!view$Var1=="",]
...
#pdf(file="figures/mid_career/4.8_ViewChangePartnership.pdf", width = 11, height= 7)
...
grants.mid<-data.frame(with(part3.grants.long, table(type.grant,time,number)))
...
#pdf(file="figures/mid_career/4.9_NumberGrantApps.pdf", height=7, width =11)
...
success.mid<-data.frame(with(part3.success.long, table(type, percent,time)))
...
#pdf(file="figures/mid_career/4.10_GrantAppSuccess.pdf", height=7, width =11)
...
##switch to long format
change.long.mid<-gather(part3.change, type, level, -Location, -gender, -Country,-nation, -Country_work, -what_participant_group, -field_research)
...
#pdf(file="figures/mid_career/4.11_ChangeSuccessRate.pdf", height=7, width =11)
...
prac.mid<-data.frame(table(part3.prac.long$year, part3.prac.long$level))
...
#pdf(file="figures/mid_career/4.12_ImportancePracticalApplication.pdf", height=7, width =11)
...
part.mid<-data.frame(table(part3.part.long$year, part3.part.long$level))
#change order of levels
...
#pdf(file="figures/mid_career/4.13_ImportancePartnersApplication.pdf", height=7, width =11)
...
#pdf(file="figures/mid_career/4.15_PerceivedImportanceFundamentalGovernment.pdf", height=7, width =11)
...
#pdf(file="figures/mid_career/4.16_PerceivedChangeResearchPriorityGovernment.pdf", height=7, width =11)
...
#pdf(file="figures/mid_career/4.17_AnticipatedChangeFunding.pdf", height=7, width =11)
...
#pdf(file="figures/mid_career/4.18_EffectNextGeneration.pdf", height=7, width =11)
