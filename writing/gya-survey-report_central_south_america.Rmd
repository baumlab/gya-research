...
#pdf(file="figures/central_south_america/4.3.1_ResearchProportion.pdf", width = 11, height= 7)
...
ggplot(res.plot, aes(percent, fill=ID)) +
  ...
  scale_x_continuous(breaks=seq(0,100,10))+scale_y_continuous(expand=c(0,0), limits=c(0,630),breaks=c(0,100, 200, 300, 400, 500,600))
...
#pdf(file="figures/central_south_america/4.3.2_ResearchProportion.pdf", width = 11, height= 7)
...
p1<-ggplot(data=c.s.am.yes.no, aes(x=changed_10yrs, y=Country, fill=Country))+ geom_bar(stat='identity') + guides(fill=FALSE)+
  ...
  geom_text(aes(label=Country), vjust=-0.5)+labs(y="Number of responses", title="Change in research type")+ scale_y_continuous(expand = c(0, 0), limits = c(0,1500))+ annotate('text', 0.5,1470, label="(a)", size=5)
...
#pdf(file="figures/central_south_america/4.4a&b_ReasonForFieldChange.pdf", width = 11, height= 7)
...
change.view.c.s.am<-aggregate(gender~ view_change_of_type, view.propor, length)
# change order of the levels
change.view.c.s.am$view_change_of_type<-factor(change.view.c.s.am$view_change_of_type, 
                                        levels(change.view.c.s.am$view_change_of_type)[c(5,3,1,2,4)])

myColors5<-(brewer.pal(9, "Blues"))
myColors5<-myColors5[c(4,4,4,4,4,4)]

#pdf(file="figures/central_south_america/4.5_ViewFieldChange.pdf", width = 11, height= 7)

ggplot(change.view.c.s.am, aes(x=view_change_of_type, y=gender, fill=view_change_of_type)) + geom_bar(stat='identity')+
...
#pdf(file="figures/central_south_america/4.6_LevelsOfPartnership.pdf", width = 11, height= 7)
...
ggplot(part, aes(x=Var1, y=Freq, fill = time),  ylim(0,375)) + 
  ...
  colScale+scale_y_continuous(expand = c(0, 0), limits = c(0,1250))
...
#pdf(file="figures/central_south_america/4.7a&b_PartnershipChange&Reason.pdf", width = 11, height= 7)
...
#pdf(file="figures/central_south_america/4.8_ViewChangePartnership.pdf", width = 11, height= 7)
...
ggplot(view, aes(x=Var1, y=Freq, fill=Var1)) + geom_bar(stat='identity')+
  ...
  labs(x="", y="Number of responses", title="Opinion of change in partnership level") + colScale+scale_y_continuous(expand = c(0, 0), limits = c(0,380), breaks = seq(0,350,50))
...
grants.c.s.am<-data.frame(with(part3.grants.long, table(type.grant,time,number)))
...
#pdf(file="figures/central_south_america/4.9_NumberGrantApps.pdf", height=7, width =11)
...
success.c.s.am<-data.frame(with(part3.success.long, table(type, percent,time)))
...
#pdf(file="figures/central_south_america/4.10_GrantAppSuccess.pdf", height=7, width =11)
...
##switch to long format
change.long.c.s.am<-gather(part3.change, type, level, -Location, -gender, -Country,-nation, -Country_work, -what_participant_group, -field_research)
...
#pdf(file="figures/central_south_america/4.11_ChangeSuccessRate.pdf", height=7, width =11)
...
prac.c.s.am<-data.frame(table(part3.prac.long$year, part3.prac.long$level))
...
#pdf(file="figures/central_south_america/4.12_ImportancePracticalApplication.pdf", height=7, width =11)
...
part.c.s.am<-data.frame(table(part3.part.long$year, part3.part.long$level))
#change order of levels
...
#pdf(file="figures/central_south_america/4.13_ImportancePartnersApplication.pdf", height=7, width =11)
...
ggplot(part.c.s.am, aes(Var2, Freq, fill=Var1))+ 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,980))
...
p1<-ggplot(fp, aes(percent, fill=year))+ geom_histogram(position='dodge', binwidth=10)  + colScale +
  ...
  scale_y_continuous(expand =c(0,0),limits=c(0,2800), breaks=seq(0, 2800, 200))+
...
#pdf(file="figures/central_south_america/4.14_DistributionFunding.pdf", height=7, width =11)
...
#pdf(file="figures/central_south_america/4.15_PerceivedImportanceFundamentalGovernment.pdf", height=7, width =11)
...
ggplot(data=perceive, aes(x=Var1, y=Freq, fill=Var1)) + 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,1100)) + colScale
...
priority<-subset(part4, select=c("Location","Country",'Country_work', "gender", "high_priority_fundamental", "high_priority_use_inspired", "high_priority_applied", "high_priority_no_change"))
...
#pdf(file="figures/central_south_america/4.16_PerceivedChangeResearchPriorityGovernment.pdf", height=7, width =11)
...
ggplot(data=per.change, aes(x=what.type, higher.priority, fill=what.type))+
  ...
  geom_text(aes(label=higher.priority, vjust=-0.5), size=3) +scale_y_continuous(expand = c(0, 0), limits = c(0,2500))+ colScale
...
#pdf(file="figures/central_south_america/4.17_AnticipatedChangeFunding.pdf", height=7, width =11)
...
ggplot(data=availability.c.s.am, aes(x=level, Freq, fill=what.type))+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,1000), breaks = seq(0,1000,200))
...
#pdf(file="figures/central_south_america/4.18_EffectNextGeneration.pdf", height=7, width =11)
...
ggplot(data=impact, aes(x=Var1, Freq, fill=Var1))+ 
 ...
 labs(x="", y="Number of responses", title="Effect of funding changes on the next generation of researchers")+
  ...
  geom_text(aes(label=Freq, vjust=-0.5), size=3)+
  scale_y_continuous(expand = c(0, 0), limits = c(0,850))+colScale
