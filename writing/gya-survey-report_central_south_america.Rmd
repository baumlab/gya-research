...
#pdf(file="figures/central_south_america/4.2_FieldofResearch_13March18.pdf", width = 11, height= 7)
...
research.c.s.america<-research[research$nation%in%cen.south.america,]
research.c.s.america <- droplevels(research.c.s.america)

## make sure that Use-inspired is the middle level in the legend
res.plot<-subset(research.c.s.america, type%in%c("percent_fundemental_research_current",  "percent_Applied_Research_current" , "percent_Use_inspired_Research_current","percent_Applied_Research_past",  "percent_Fundamental_Research_past" , "percent_Use_inspired_Research_past"))
...
p1 <- ggplot(xs$Fundamental, aes(number, Freq, fill=time), width=0.7) + 
  ...
  colScale+scale_y_continuous(expand = c(0, 0), limits = c(0,125), breaks = seq(0,125, 25))
