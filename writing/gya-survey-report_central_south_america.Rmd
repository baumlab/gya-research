...
#pdf(file="figures/central_south_america/responses_country_1Mar18.pdf", width = 11, height= 8)
...
#pdf(file="figures/central_south_america/responses_country_gapplot_1Mar18.pdf", height=8, width=11)
...
#pdf(file="figures/central_south_america/responses_country_10+_gapplot_1Mar18.pdf", height=8, width=11)
...
color1<-c('#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4')
#pdf(file="figures/central_south_america/responses_country_10+&10-_gapplot_1Mar18.pdf", height=8, width=15)
...
```{r eval=FALSE, fig.cap="Figure 4.1 Number of  survey respondents by career stage", fig.width=14, message=FALSE, warning=FALSE, include=FALSE}
...
```{r eval=FALSE, fig.cap="Figure 4.2 Survey responses by field of research", fig.width=14, message=FALSE, warning=FALSE, include=FALSE}
...
#pdf(file="figures/global/4.1and4.2_CareerStageAndFieldOfResearch.pdf", width = 11, height= 7)
...
```{r eval=FALSE, fig.cap="Figure 4.6 Current vs past level of partnership outside of academia. Researchers indicated the level of partnership that their current and past (10 years ago) research program had outside of academia).", message=FALSE, warning=FALSE, include=FALSE}
...
```{r eval=FALSE, fig.cap="Figure 4.7a&b Did it change and reasons for change in level of external research partnerships over the past decade.", message=FALSE, warning=FALSE, include=FALSE}
### was there change
...
```{r eval=FALSE, fig.cap="Figure 4.8 View of change in external partnerships. Researchers were asked how they viewed the change in the level of partnership with external groups.", message=FALSE, warning=FALSE, include=FALSE}

view<-data.frame(table(survey$view_change_partnership))
view<-view[!view$Var1=="",]
...
```{r eval=FALSE, fig.cap="Fig. 4.9 Number of research grant applications by research category in 2006-2010 and 2011-2015.", fig.height=12, message=FALSE, warning=FALSE, include=FALSE}
part3.grants.long<-read.csv(file="../data/gya-part3.grants.long.csv")
...
#pdf(file="figures/global/4.9_NumberGrantApps.pdf", height=7, width =11)
...
```{r eval=FALSE, fig.cap="Fig 4.10 Research grant application success over the past 10 years. Researchers were asked to estimate the percentage of their research grant applications that were successful, in 2006-2010 and in 2011-2015. Respondents also had the choice to answer No need for applications for this research type.", message=FALSE, include=FALSE}
part3.success.long<-read.csv(file="../data/gya-part3.success.long.csv")
...
#pdf(file="figures/global/4.10_GrantAppSuccess.pdf", height=7, width =11)
...
```{r eval=FALSE, fig.cap="Fig 4.11 Change in grant success rates over the past 10 years. Researchers were asked if they thought that grant sucecss rates have changed in the past 10 years, for each research category.", message=FALSE, include=FALSE}

##switch to long format
change.long.gbl<-gather(part3.change, type, level, -Location, -gender, -Country,-nation, -Country_work, -what_participant_group, -field_research)
...
```{r eval=FALSE, fig.cap="Fig 4.12 Importance of practical application of research over the past 10 years. Researchers were asked how important it was to suggest practical applications of their research to ensure that the grant was successful, in 2006-2010 and in 2011-2015.", message=FALSE, include=FALSE}
...
```{r eval=FALSE, fig.cap="Fig 4.14 Distribution of research funding over the past 10 years. Researchers were asked to estimate the distribution of their research funding sources in 2006-2010 and 2011-2015.", message=FALSE, warning=FALSE, include=FALSE}
p3_master.long<-read.csv(file="../data/gya-p3_master.long.csv")
...
#pdf(file="figures/global/4.14_DistributionFunding.pdf", height=7, width =11)
...
```{r eval=FALSE, fig.cap="Fig 4.15 Perceived importance of fundamental research to their government. Researchers were asked how important they thought fundamental research was to the their government. Responses were/were not significantly different between genders.", message=FALSE, warning=FALSE, include=FALSE}
...
```{r eval=FALSE, fig.cap="Fig 4.16 Perceived change in research priority by their government. Researchers were asked whether any types of research had become higher priority for the their government. Responses were/were not significantly different between genders.", message=FALSE, warning=FALSE, include=FALSE}
...
```{r eval=FALSE, fig.cap="Fig 4.17 Anticipated change in research funding in next five years. Researchers were asked whether the availability of research funding would change in the next five years.", message=FALSE, warning=FALSE, include=FALSE}
...
## switch to long format
availability.change.long.gbl<-gather(availability.change, what.type, level, -gender, -Location, -Country, -Country_work)
...
```{r eval=FALSE, fig.cap="Fig 4.18 Effect of change in research funding on research careers of next generation. Researchers were asked if they though that changes in funding availability would influence the likelihood of the next generation pursuing careers in research. Responses were/were not significantly different between genders.", message=FALSE, warning=FALSE, include=FALSE}
