...
ggplot() + geom_histogram(data = 
                          ...
                          aes(x = overall.per, y = -..count.., fill = curr.past), binwidth=10, bins=seq(0, 100, 10), position='dodge') +
           geom_histogram(data = 
                          res.port.dev.long[res.port.dev.long$overall.per > 0, ],
                          aes(x = overall.per, y = ..count.., fill = curr.past),  binwidth=10, bins=seq(0, 100, 10), position='dodge') +colScale
# 
# ggplot(res.plot, aes(percent, fill=ID)) +
#     geom_histogram(position='dodge', binwidth=10, bins=seq(0, 100, 10))  +
#     guides(fill=guide_legend(title=NULL, reverse=FALSE, nrow=2)) +
