...
**Introduction**  
In addition to the official data presented in Chapters 2 and 3, we also developed and ran a quantitative online global to query researchers about their perceptions of, and experiences with, funding for fundamental research. An important aim of the global was to provide an understanding researcher's personal experiences and outlook on the research funding landscape. We had an excellent response to the survey, with over xxxx  researchers completing it, suggesting that fundamental research funding is a high priority topic for Canadian researchers. Herein, we detail the survey questions and results. 
...
developing<-c("Brazil","South Africa", "Mauritius", "Uruguay","Turkey","Indonesia", "Morocco", "India", "Bangladesh","Ghana", "Malaysia","Vietnam","Nigeria", "Egypt", "Montenegro",              
 ...
 "Mozambique", "Dominican Republic", "Lebanon","Gabon" ) ## the list has not been re evaluated for 2017 but Uruguay and Chile will probably be graduating from this
...
pdf(file="figures/global/developing/4.1_CareerStage.pdf", width = 11, height= 7)
...
pdf(file="figures/global/developing/4.2_FieldofResearch.pdf", width = 11, height= 7)
...
pdf(file="figures/global/developing/4.3.1_ResearchProportion.pdf", width = 11, height= 7)
...
ggplot(res.plot, aes(percent, fill=ID)) +
  ...
  scale_x_continuous(breaks=seq(0,100,10))+scale_y_continuous(expand=c(0,0), limits=c(0,20),breaks=c(0,5,10,15,20))
...
pdf(file="figures/global/developing/4.3.2_ResearchProportion.pdf", width = 11, height= 7)
...
p2<-ggplot(sum.global, aes(x=Var1, y=Freq, fill=Var1)) + geom_bar(stat='identity')+ 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 35))+annotate('text', 5.35,33.8, label="(b)", size=5)+geom_text(aes(label=Freq), vjust=-0.5, size=3)
...
pdf(file="figures/global/developing/4.4a&b_ReasonForFieldChange.pdf", width = 11, height= 7)
...
pdf(file="figures/global/developing/4.5_ViewFieldChange.pdf", width = 11, height= 7)
...
ggplot(change.view.glb, aes(x=view_change_of_type, y=gender, fill=view_change_of_type)) + geom_bar(stat='identity')+
  ...
  theme(panel.grid.major = element_blank(),legend.text=element_text(size = 9), panel.grid.minor = element_blank())+ labs(x="", y="Number of responses", title="Opinion of change in research type (Developing nations)")+geom_text(aes(label=gender), vjust=-0.5, size=3)+scale_y_continuous(expand = c(0, 0), limits = c(0,30))+scale_fill_manual(name='view_change_of_type', values=myColors5)#+annotate('text', 5.4,133, label="(c)", size=5)
...
pdf(file="figures/global/developing/4.6_LevelsOfPartnership.pdf", width = 11, height= 7)
...
ggplot(part, aes(x=Var1, y=Freq, fill = time),  ylim(0,375)) + 
  ...
  colScale+scale_y_continuous(expand = c(0, 0), limits = c(0,52))
...
pdf(file="figures/global/developing/4.7a&b_PartnershipChange&Reason.pdf", width = 11, height= 7)
...
pdf(file="figures/global/developing/4.8_ViewChangePartnership.pdf", width = 11, height= 7)
...
ggplot(view, aes(x=Var1, y=Freq, fill=Var1)) + geom_bar(stat='identity')+
  ...
  labs(x="", y="Number of responses", title="Opinion of change in level of external partnerships (Developing nations)") + colScale+scale_y_continuous(expand = c(0, 0), limits = c(0,18), breaks = seq(0,17,5))
...
pdf(file="figures/global/developing/4.9_NumberGrantApps.pdf", height=7, width =11)
...
p1 <- ggplot(xs$Fundamental, aes(number, Freq, fill=time), width=0.7) + 
  ...
  colScale+scale_y_continuous(expand = c(0, 0), limits = c(0,70), breaks = c(0,20,40,60))
...
pdf(file="figures/global/developing/4.10_GrantAppSuccess.pdf", height=7, width =11)
...
pdf(file="figures/global/developing/4.11_ChangeSuccessRate.pdf", height=7, width =11)
...
pdf(file="figures/global/developing/4.12_ImportancePracticalApplication.pdf", height=7, width =11)
...
pdf(file="figures/global/developing/4.13_ImportancePartnersApplication.pdf", height=7, width =11)
...
pdf(file="figures/global/developing/4.14_DistributionFunding.pdf", height=7, width =11)
...
pdf(file="figures/global/developing/4.15_PerceivedImportanceFundamentalGovernment.pdf", height=7, width =11)

ggplot(data=perceive, aes(x=Var1, y=Freq, fill=Var1)) + 
      geom_bar(stat='identity', position='dodge')+ 
      labs(x="", y="Number of responses", fill="", title="Perceived importance of fundamental research to their government (Developing nations)")+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,32)) + colScale
...
pdf(file="figures/global/developing/4.16_PerceivedChangeResearchPriorityGovernment.pdf", height=7, width =11)
...
ggplot(data=per.change, aes(x=what.type, higher.priority, fill=what.type))+
        ...
        theme(aspect.ratio=3/4, 
              ...
              panel.grid.major = element_blank(),
              panel.grid.minor = element_blank(), axis.title.y=element_text(size=11),  axis.text.y=element_text(size=9), plot.title = element_text(hjust = 0.5)) +
        labs(x="", y="Number of responses", fill="", title="Perceived change in research priority by their government (Developing nations)") +
  scale_x_discrete(labels=c( "Fundamental", "Use-inspired","Applied", "No change"))   +
  geom_text(aes(label=higher.priority, vjust=-0.5), size=3) +scale_y_continuous(expand = c(0, 0), limits = c(0,85))+ colScale
...
pdf(file="figures/global/developing/4.17_AnticipatedChangeFunding.pdf", height=7, width =11)
...
ggplot(data=availability.gbl, aes(x=level, Freq, fill=what.type))+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,43), breaks = seq(0,40,10))
...
pdf(file="figures/global/developing/4.18_EffectNextGeneration.pdf", height=7, width =11)
...
ggplot(data=impact, aes(x=Var1, Freq, fill=Var1))+ 
 ...
 labs(x="", y="Number of responses", title="Effect of funding changes on the next generation of researchers (Developing nations)")+
  ...
  geom_text(aes(label=Freq, vjust=-0.5), size=3)+
  scale_y_continuous(expand = c(0, 0), limits = c(0,28))+colScale
