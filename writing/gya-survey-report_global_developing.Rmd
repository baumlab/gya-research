...
# going to average the current - past columns for each to plot
...
ggplot(change.long, aes(type, aver, fill = type))+ geom_bar(stat = "identity") +scale_fill_manual(values = mycols)+ guides(fill = FALSE) +
