...
##switch to long format
change.long.gbl<-gather(part3.change.dev, type, level, -Location, -nation, -gender, -Country, -Country_work, -what_participant_group, -field_research)
...
ggplot(data=perceive, aes(x=Var1, y=Freq, fill=Var1)) + 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,112)) + colScale
...
ggplot(data=per.change, aes(x=what.type, higher.priority, fill=what.type))+
  ...
  geom_text(aes(label=higher.priority, vjust=-0.5), size=3) +scale_y_continuous(expand = c(0, 0), limits = c(0,250))+ colScale
...
ggplot(data=availability.gbl, aes(x=level, Freq, fill=what.type))+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,105), breaks = seq(0,120,20))
