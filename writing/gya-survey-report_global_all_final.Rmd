...
#load data
dev <- read.csv("/Users/kristinatietjen/Documents/git_hub/gya-research/data/globalreport_fromAX/gya_survey_clean_final_all.csv")
...
#pdf(file="figures/all/4.1_FieldofResearch_all.pdf", width = 11, height= 7)
#svg(file="figures/all/4.1_FieldofResearch_all.svg", width = 11, height= 7)

ggplot(field, aes(x = reorder(Var1, -Freq), Freq, fill=Var1)) + 
    geom_bar(stat='identity',position = position_dodge(width=0.5)) + 
  labs(y="Number of respondents",x="", title="Responses by field of research (all)")  +
...
#pdf(file="figures/all/4.2_CareerStage_all.pdf", width = 11, height= 7)
#svg(file="figures/all/4.2_CareerStage_all.svg", width = 11, height= 7)
...
ggplot(experience, aes(x = reorder(Var1, -Freq), Freq, fill=Var1)) + 
  ...
  labs(y="Number of respondents", x="", title="Responses by career stage (all)") +
...
p3 <- p1 %+% xs$Applied
p1<-p1+scale_fill_manual(name = "ID",values = c('#97CCFF','#42A3FF'), labels=c("2006-2010", "2011-2015"))+labs(x="", title="Type of research by proportion (all)")+ theme(plot.margin=unit(c(1,1,-0.45,1), "cm"), plot.title = element_text(hjust = 0.5, size = 14))+ scale_y_continuous(expand=c(0,0), limits=c(0,330),breaks=seq(0,300,100))
p2<-p2+scale_fill_manual(name = "ID",values =c('#C8DF95','#9BC53D'), labels=c("2006-2010", "2011-2015"))+labs(x="")+ theme(plot.margin=unit(c(-0.25,1,-0.3,1), "cm")) + scale_y_continuous(expand=c(0,0), limits=c(0,650),breaks=seq(0,700,100))
p3<-p3+scale_fill_manual(name = "ID",values =c('#F0A490','#E55934'), labels=c("2006-2010", "2011-2015"))+ theme(plot.margin=unit(c(-0.5,1,1,1), "cm"))+ scale_y_continuous(expand=c(0,0), limits=c(0,801),breaks=seq(0,800,200))


#pdf(file="figures/all/4.3_ResearchProportion_HI.pdf", width = 11, height= 7)
#svg(file="figures/all/4.3_ResearchProportion_HI.svg", width = 11, height= 7)
...
#pdf(file="figures/all/4.3b_ReasonForFieldChange_HI.pdf", width = 11, height= 7)
#svg(file="figures/all/4.3b_ReasonForFieldChange_HI.svg", width = 11, height= 7)
...
ggplot(sum.reason, aes(x=Var1, y=Freq, fill=Var1)) + geom_bar(stat='identity')+ 
  ...
  guides(fill=FALSE) +
  colScale+
  labs(y="Number of respondents", title="Reason for change in research type")+
  scale_y_continuous(expand = c(0, 0), limits = c(0, 600))#+annotate('text', 5.4,795, label="(b)", size=5)#+geom_text(aes(label=Freq), vjust=-0.5, size=3)
...
#pdf(file="figures/all/4.3C_ViewFieldChange_HI.pdf", width = 11, height= 7)
#svg(file="figures/all/4.3C_ViewFieldChange_HI.svg", width = 11, height= 7)
...
ggplot(view, aes(x=Var1, y=Freq, fill = Var1)) + geom_bar(stat='identity')+
  ...
  guides(fill=FALSE)+ 
  colScale+
  labs(x="", y="Number of respondents", title="Opinion of research type change")+
...
#pdf(file="figures/all/4.4A_PerceivedImportanceFundamentalGovernment_HI.pdf", height=7, width =11)
#svg(file="figures/all/4.4A_PerceivedImportanceFundamentalGovernment_HI.svg", width = 11, height= 7)

ggplot(data=import, aes(x=Var1, y=Freq, fill=Var1)) + 
      geom_bar(stat='identity', position='dodge')+ 
      labs(x="", y="Number of respondents", fill="", title="Perceived importance of fundamental research to their government")+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,700), breaks = seq(0,700, 100)) + colScale
...
#pdf(file="figures/all/4.4B_PerceivedChangeResearchPriorityGovernment.pdf", height=7, width =11)
#svg(file="figures/all/4.4B_PerceivedChangeResearchPriorityGovernment.svg", width = 11, height= 7)
...
ggplot(data=sum.priority, aes(x=Var1, Freq, fill=Var1))+
        ...
        panel.grid.major.x = element_blank(),
              ...
              axis.title.y=element_text(size=12),  
        plot.title = element_text(hjust = 0.5, size = 14)) +
        labs(x="", y="Number of respondents", fill="", title="Perceived change in research priority by their government") +
  scale_x_discrete(labels=c( "Fundamental", "Use-inspired","Applied", "No change"))   +
  #geom_text(aes(label=higher.priority, vjust=-0.5), size=3) +
  scale_y_continuous(expand = c(0, 0), limits = c(0,1600))+ colScale
...
#pdf(file="figures/all/4.5_ChangeSuccessRate_HI.pdf", height=7, width =11)
#svg(file="figures/all/4.5_ChangeSuccessRate_HI.svg", width = 11, height= 7)
...
ggplot(data=success.change, aes(x=level, Freq, fill=type))+ facet_wrap(~type, nrow=3)+
  ...
  labs(x="", y="Number of responses", fill="", title="Change in grant success rate")+ colScale4+
...
#pdf(file="figures/all/4.6_DistributionFunding_HI.pdf", height=7, width =11)
#svg(file="figures/all/4.6_DistributionFunding_HI.svg", width = 11, height= 7)
...
#pdf(file="figures/all/4.7A_ImportancePracticalApplication.pdf", height=7, width =11)
#svg(file="figures/all/4.7A_ImportancePracticalApplication.svg", width = 11, height= 7)
...
ggplot(prac, aes(Var2, Freq, fill=Var1)) + 
  ...
  labs(x="", y="Number of respondents", title="Importance of practical application of research for grant success")+ colScale7+
...
#pdf(file="figures/all/4.7B_ImportancePartnersApplication_HI.pdf", height=7, width =11)
#svg(file="figures/all/4.7B_ImportancePartnersApplication_HI.svg", width = 11, height= 7)

ggplot(part, aes(Var2, Freq, fill=Var1))+ 
  geom_bar(stat="identity", position = "dodge")+
  #geom_text(aes(label=Freq), vjust=-0.7, hjust=0.5, size=3, position = position_dodge(width = 0.8))+
    guides(fill=guide_legend(title=NULL, reverse=FALSE)) +
    labs(x="", y="Number of respondents", title="Importance of including partners (non-academia) for the success of grant applications")+
...
#pdf(file="figures/all/4.8A_LevelsOfPartnership.pdf", width = 11, height= 7)
#svg(file="figures/all/4.8A_LevelsOfPartnership.svg", width = 11, height= 7)
...
ggplot(part.level, aes(x=Var2, y=Freq, fill = Var1),  ylim(0,375)) + 
  ...
  labs(x="", y="Number of respondents", fill="", title="Levels of partnerships outside of academia")+
  theme(panel.grid.major.y = element_line(linetype = 3, color = "darkgrey", size = .3),
        panel.grid.major.x = element_blank(),
        panel.grid.minor = element_blank(),
        legend.key=element_blank(),legend.text=element_text(size = 12),
...
g1<-ggplot(data=part.change, aes(x=Var1, y=Freq, fill=Var1))+ 
    ...
    guides(fill=FALSE) + 
    labs(x="", y="Number of respondents",title="Change in level of partnerships")+
...
g2<-ggplot(change.part, aes(x=Var1, y=Freq, fill=Var1)) + 
    ...
    theme(axis.text.x=element_text( size=12, color = "black"),
        ...
        panel.grid.major.x = element_blank(),
          panel.grid.minor = element_blank(), plot.title = element_text(hjust = 0.5, size = 14)) + 
  #geom_text(aes(label=Freq), vjust=-0.5, size=3)+
  labs(x="", y="Number of respondents", title="Reason for change in level of partnerships (all)")+
  colScale+
  scale_y_continuous(expand = c(0, 0), limits = c(0,550))

#annotate('text', 5,420, label="(b)", size=7)+ 

#pdf(file="figures/all/4.8B_PartnershipChange&Reason.pdf", width = 11, height= 7)
#svg(file="figures/all/4.8B_PartnershipChange.svg", width = 11, height= 7)
...
#pdf(file="figures/all/4.8C_ViewChangePartnership.pdf", width = 11, height= 7)
#svg(file="figures/all/4.8C_ViewChangePartnership.svg", width = 11, height= 7)
...
ggplot(view, aes(x=Var1, y=Freq, fill=Var1)) + geom_bar(stat='identity')+
  ...
  theme(panel.grid.major.y = element_line(linetype = 3, color = "darkgrey", size = .3),
        ...
        axis.title.y=element_text(size=12), 
        plot.title = element_text(hjust = 0.5, size = 14)) + 
  labs(x="", y="Number of respondents", title="Opinion of change in partnership level") + 
  colScale+
...
#pdf(file="figures/all/4.9_AnticipatedChangeFunding.pdf", height=7, width =11)
#svg(file="figures/all/4.9_AnticipatedChangeFunding.svg", width = 11, height= 7)
...
ggplot(data=ant, aes(x=Var2, Freq, fill=Var1))+
    ...
    theme( axis.text.x=element_text(size=12, color = "black"),
        ...
        panel.grid.major.x = element_blank(),
          ...
          plot.title = element_text(hjust = 0.5, size = 14)) +
    guides(fill=FALSE)+
    labs(x="", y="Number of respondents", fill="", title="Anticipated change in research funding")+
...
#pdf(file="figures/all/4.10_EffectNextGeneration.pdf", height=7, width =11)
#svg(file="figures/all/4.10_EffectNextGeneration.svg", width = 11, height= 7)
...
ggplot(data=future, aes(x=Var1, Freq, fill=Var1))+ 
    geom_bar(stat='identity', position="dodge")  +
        scale_x_discrete(labels=c("Increase\nconsiderably", "Increase\nslightly", 
                                    "Stay the\nsame", "Decrease\nslightly", "Decrease\nconsiderably", "Can't\ncomment"))+
    guides(fill=FALSE) +
 labs(x="", y="Number of respondents", title="Effect of funding changes on the next generation of researchers")+
  theme(axis.text.x=element_text(angle=-45, hjust = 0.1, size=12, color = "black"),
         axis.text.y=element_text(size = 12, color = "black"),
       panel.grid.major.y = element_line(linetype = 3, color = "darkgrey", size = .3),
        panel.grid.major.x = element_blank(),
