...
developed<-c("Canada","Australia", "Russia","Germany", "United Kingdom", "Netherlands", "United States", "New Zealand","France", "Switzerland", "Poland",              
 "Portugal", "Italy",  "Belgium",  "Norway", "Finland", "Greece","Cyprus",  "Hungary", "Spain","Romania", "Denmark","Austria", "Sweden",                
 "Estonia", "Malta", "Iceland", "Ireland" )
...
```{r, eval=FALSE, fig.cap="Number of responses by country", fig.width=14, message=FALSE, warning=FALSE, include=FALSE}
...
write.csv(locations, file="data/country_responses_4Jan18.csv", row.names = FALSE)
...
pdf(file="figures/global/responses_country_4Jan18.pdf", width = 11, height= 8)
...
pdf(file="figures/global/responses_country_gapplot_4Jan18.pdf", height=8, width=11)
...
pdf(file="figures/global/responses_country_10+_gapplot_4Jan18.pdf", height=8, width=11)
...
color1<-c('#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4')
pdf(file="figures/global/responses_country_10+&10-_gapplot_4Jan18.pdf", height=8, width=15)
...
```{r, echo=FALSE, fig.cap="Figure 4.1 + 4.2 Career Stage and Field of research", message=FALSE, warning=FALSE}
##plot1
