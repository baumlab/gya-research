...
n.gbl.europe.plus<-survey[survey$nation%in%europe.plus,]

#check
unique(n.gbl.europe.plus$nation)
n.gbl.europe.plus <- droplevels(n.gbl.europe.plus)


#Gender:
n.eu.plus.res.men <- n.gbl.europe.plus[n.gbl.europe.plus$gender=="Male",]               #Count how many responses from  male researchers
percent.men<-((dim(n.eu.plus.res.men)[1])/(dim(n.gbl.europe.plus)[1]))*100      #Calculate the % of responses from  male researchers
n.eu.plus.res.women <- n.gbl.europe.plus[n.gbl.europe.plus$gender=="Female",]           #Count how many responses from  female researchers
percent.women<-((dim(n.eu.plus.res.women)[1])/(dim(n.gbl.europe.plus)[1]))*100  #Calculate the % of responses from  female researchers

#Career Stage Tabulations:
#table(n.gbl.europe.plus$what_participant_group)
n.seniorac <- n.gbl.europe.plus[n.gbl.europe.plus$what_participant_group=="Senior academic researcher with >10 years of experience applying for research grants",]
percent.seniorac<-((dim(n.seniorac)[1])/(dim(n.gbl.europe.plus)[1]))*100 #Calculate the % of responses from  senior academic researchers
n.earlyac <- n.gbl.europe.plus[n.gbl.europe.plus$what_participant_group=="Early career academic researcher with <10 years experience applying for research grants since completion of PhD",]
percent.earlyac<-((dim(n.earlyac)[1])/(dim(n.gbl.europe.plus)[1]))*100 #Calculate the % of responses from  early academic researchers
n.pdf <- n.gbl.europe.plus[n.gbl.europe.plus$what_participant_group=="Postdoctoral fellow or research assistant with experience applying for research grants, or anticipating the need to apply for grants in the near future",]
percent.pdf<-((dim(n.pdf)[1])/(dim(n.gbl.europe.plus)[1]))*100 #Calculate the % of responses from  post-docs
n.nonACearly <- n.gbl.europe.plus[n.gbl.europe.plus$what_participant_group=="Non-academic researcher conducting or managing research in industry or government with <10 years of experience",]
percent.nonACearly<-((dim(n.nonACearly)[1])/(dim(n.gbl.europe.plus)[1]))*100 #Calculate the % of responses from early career non-academics
n.nonACsenior <- n.gbl.europe.plus[n.gbl.europe.plus$what_participant_group=="Non-academic researcher conducting or managing research in industry or government with >10 years of experience",]
percent.nonACsenior<-((dim(n.nonACsenior)[1])/(dim(n.gbl.europe.plus)[1]))*100 #Calculate the % of responses from early career non-academics
n.unk <- n.gbl.europe.plus[n.gbl.europe.plus$what_participant_group=="",]
percent.unk<-((dim(n.unk)[1])/(dim(n.gbl.europe.plus)[1]))*100 #Calculate the % of responses from unknown career stage

#Discipline Tabulations:
n.natural <- n.gbl.europe.plus[n.gbl.europe.plus$field_research=="Natural Science",]
percent.natural <- ((dim(n.natural)[1])/(dim(n.gbl.europe.plus)[1]))*100 #Calculate the % of responses from  natural scientists
n.physics <- n.gbl.europe.plus[n.gbl.europe.plus$field_research=="Physical Science (eg. math, physics, chemistry, computer science)",]
percent.physics <- ((dim(n.physics)[1])/(dim(n.gbl.europe.plus)[1]))*100 #Calculate the % of responses from  physical scientists
n.med <- n.gbl.europe.plus[n.gbl.europe.plus$field_research=="Medicine and Life Science",]
percent.med <- ((dim(n.med)[1])/(dim(n.gbl.europe.plus)[1]))*100 #Calculate the % of responses from  med/life scientists
n.eng <- n.gbl.europe.plus[n.gbl.europe.plus$field_research=="Engineering",]
percent.eng <- ((dim(n.eng)[1])/(dim(n.gbl.europe.plus)[1]))*100 #Calculate the % of responses from  engineering scientists
n.int <- n.gbl.europe.plus[n.gbl.europe.plus$field_research=="Interdisciplinary Science",]
percent.int <- ((dim(n.int)[1])/(dim(n.gbl.europe.plus)[1]))*100 #Calculate the % of responses from  interdisciplinary scientists
n.ssh <- n.gbl.europe.plus[n.gbl.europe.plus$field_research=="Social Science / Humanities",]
percent.ssh <- ((dim(n.ssh)[1])/(dim(n.gbl.europe.plus)[1]))*100 #Calculate the % of responses from  interdisciplinary scientists
...
locations<-aggregate(gender ~ nation, n.gbl.europe.plus, length)
...
locations.more<-aggregate(gender ~ nation, n.gbl.europe.plus, length)
...
locations.less<-aggregate(gender ~ nation, n.gbl.europe.plus, length)
