...
countrylist.wCA<-countrylist[!countrylist=="Canada"]

####leaving off here

n.gbl.wCA.res <- survey[survey$Country_work=countrylist.wCA | (survey$Country_work=="" & survey$Country=countrylist.wCA),]  ##removing CA responses
