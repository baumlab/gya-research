...
percent.seniorac<-((dim(n.seniorac)[1])/(dim(n.gbl.wCA.res)[1]))*100 #Calculate the % of responses from  senior academic researchers
...
#pdf(file="figures/w_out_Canada/4.1_CareerStage.pdf", width = 11, height= 7)
...
#pdf(file="figures/w_out_Canada/4.2_FieldofResearch.pdf", width = 11, height= 7)
...
#pdf(file="figures/w_out_Canada/4.1and4.2_CareerStageAndFieldOfResearch_wout_ca.pdf", width = 11, height= 7)
...
#pdf(file="figures/w_out_Canada/4.3.1_ResearchProportion.pdf", width = 11, height= 7)
...
ggplot(res.plot, aes(percent, fill=ID)) +
  ...
  scale_x_continuous(breaks=seq(0,100,10))+scale_y_continuous(expand=c(0,0), limits=c(0,350),breaks=c(0,50,100,150, 200,250,300,350))
...
p1 <- ggplot(xs$Fundamental,aes(percent, fill=time)) +
  ...
  scale_x_continuous(breaks=seq(0,100,10))+scale_y_continuous(expand=c(0,0), limits=c(0,350),breaks=c(0,100,200,300))
...
#pdf(file="figures/w_out_Canada/4.3.2_ResearchProportion.pdf", width = 11, height= 7)
...
#Change yes or no
yes.no<-subset(research.change.w.CA, select=c("Location","Country", "Country_work",  "gender", "changed_10yrs","nation"))
...
p1<-ggplot(data=global.yes.no, aes(x=changed_10yrs, y=gender, fill=gender))+ geom_bar(stat='identity') + guides(fill=FALSE)+
  theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank(), axis.title.x=element_blank(), plot.title = element_text(hjust = 0.5))+geom_text(aes(label=gender), vjust=-0.5)+labs(y="Number of responses", title="Change in research type\n(without Canadian responses)")+ scale_y_continuous(expand = c(0, 0), limits = c(0,830))+ annotate('text', 0.5,820, label="(a)", size=5)

####reason for change  
reason<-subset(research.change.w.CA, select=c("Location","Country","Country_work", "nation",  "gender", "Main_reason_change_interest_related",
...
p2<-ggplot(sum.global, aes(x=Var1, y=Freq, fill=Var1)) + geom_bar(stat='identity')+ 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 900))+annotate('text', 5.4,860, label="(b)", size=5)+geom_text(aes(label=Freq), vjust=-0.5, size=3)


#pdf(file="figures/w_out_Canada/4.4_ReasonForFieldChange.pdf", width = 11, height= 7)

#print(p2)

#dev.off()

#pdf(file="figures/w_out_Canada/4.4a&b_ReasonForFieldChange.pdf", width = 11, height= 7)
...
#pdf(file="figures/w_out_Canada/4.5_ViewFieldChange.pdf", width = 11, height= 7)
...
ggplot(change.view.glb, aes(x=view_change_of_type, y=gender, fill=view_change_of_type)) + geom_bar(stat='identity')+
  ...
  theme(panel.grid.major = element_blank(),legend.text=element_text(size = 9), panel.grid.minor = element_blank())+ labs(x="", y="Number of responses", title="Opinion of change in research type (without Canadian responses)")+geom_text(aes(label=gender), vjust=-0.5, size=3)+scale_y_continuous(expand = c(0, 0), limits = c(0,270))+scale_fill_manual(name='view_change_of_type', values=myColors5)#+annotate('text', 5.4,133, label="(c)", size=5)
...
#pdf(file="figures/w_out_Canada/4.1_13apr_right.a.pdf", width = 8, height = 11)
...
#pdf(file="figures/w_out_Canada/4.6_LevelsOfPartnership.pdf", width = 11, height= 7)
...
ggplot(part, aes(x=Var1, y=Freq, fill = time),  ylim(0,375)) + 
  ...
  colScale+scale_y_continuous(expand = c(0, 0), limits = c(0,700))
...
g1<-ggplot(data=change.part.glb, aes(x=Var1, y=Freq, fill=Var1))+ 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,880))
...
#pdf(file="figures/w_out_Canada/4.7a&b_PartnershipChange&Reason.pdf", width = 11, height= 7)
...
#pdf(file="figures/w_out_Canada/4.8_ViewChangePartnership.pdf", width = 11, height= 7)
...
ggplot(view, aes(x=Var1, y=Freq, fill=Var1)) + geom_bar(stat='identity')+
  ...
  labs(x="", y="Number of responses", title="Opinion of change in level of external partnerships (without Canadian responses)") + colScale+scale_y_continuous(expand = c(0, 0), limits = c(0,230), breaks = seq(0,300,50))
...
#pdf(file="figures/w_out_Canada/4.2_13Apr.pdf")
...
#pdf(file="figures/w_out_Canada/4.9_NumberGrantApps.pdf", height=7, width =11)
...
pdf(file="figures/w_out_Canada/4.10_GrantAppSuccess.pdf", height=7, width =11)
...
#pdf(file="figures/w_out_Canada/4.11_ChangeSuccessRate.pdf", height=7, width =11)
...
#pdf(file="figures/w_out_Canada/4.12_ImportancePracticalApplication.pdf", height=7, width =11)
...
#pdf(file="figures/w_out_Canada/4.13_ImportancePartnersApplication.pdf", height=7, width =11)
...
p10<-ggplot(prac, aes(Var2, Freq, fill=Var1)) + 
  geom_bar(stat="identity", position = "dodge")+
  theme(aspect.ratio=3/4, panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        legend.key=element_blank(),
...
p11<-ggplot(part, aes(Var2, Freq, fill=Var1))+ 
  geom_bar(stat="identity", position = "dodge")+
    guides(fill=guide_legend(title=NULL, reverse=FALSE)) +
    labs(x="", y="")+
  scale_x_discrete(labels=c("Mandatory", "Quite\n important", 'Somewhat\n important',"Not very\n important", 'Not at all\n important', "Can't\n comment"))+
...
#pdf(file="figures/w_out_Canada/4.3_13Apr.pdf", width = 11, height= 7)
...
#pdf(file="figures/w_out_Canada/4.14_DistributionFunding.pdf", height=7, width =11)
...
#pdf(file="figures/w_out_Canada/4.15_PerceivedImportanceFundamentalGovernment.pdf", height=7, width =11)
...
#pdf(file="figures/w_out_Canada/4.16_PerceivedChangeResearchPriorityGovernment.pdf", height=7, width =11)
...
ggplot(data=per.change, aes(x=what.type, higher.priority, fill=what.type))+
  ...
  geom_text(aes(label=higher.priority, vjust=-0.5), size=3) +scale_y_continuous(expand = c(0, 0), limits = c(0,1300))+ colScale
...
#pdf(file="figures/w_out_Canada/4.17_AnticipatedChangeFunding.pdf", height=7, width =11)
...
ggplot(data=availability.gbl, aes(x=level, Freq, fill=what.type))+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,660), breaks = seq(0,650,100))
...
#pdf(file="figures/w_out_Canada/4.18_EffectNextGeneration.pdf", height=7, width =11)
...
ggplot(data=impact, aes(x=Var1, Freq, fill=Var1))+ 
 ...
 labs(x="", y="Number of responses", title="Effect of funding changes on the next generation of researchers (without Canadian responses)")+
  ...
  geom_text(aes(label=Freq, vjust=-0.5), size=3)+
  scale_y_continuous(expand = c(0, 0), limits = c(0,510))+colScale
