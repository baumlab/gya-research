---
title: "Global (without Canada) online survey on fundamental research"
author: ''
date: "9 May 2017"
output:
  pdf_document: null
...
**Introduction**  
In addition to the official data presented in Chapters 2 and 3, we also developed and ran a quantitative online n.gbl.wCA.res to query researchers about their perceptions of, and experiences with, funding for fundamental research. An important aim of the n.gbl.wCA.res was to provide an understanding researcher's personal experiences and outlook on the research funding landscape. We had an excellent response to the survey, with over xxxx  researchers completing it, suggesting that fundamental research funding is a high priority topic for Canadian researchers. Herein, we detail the survey questions and results. 
...
##removing CA responses
n.gbl.wCA.res <- survey[survey$nation!="Canada",]

#Count how many responses from researchers w/out CA

#Gender:
n.gbl.res.men <- n.gbl.wCA.res[n.gbl.wCA.res$gender=="Male",]               #Count how many responses from  male researchers
percent.men<-((dim(n.gbl.res.men)[1])/(dim(n.gbl.wCA.res)[1]))*100      #Calculate the % of responses from  male researchers
n.gbl.res.women <- n.gbl.wCA.res[n.gbl.wCA.res$gender=="Female",]           #Count how many responses from  female researchers
percent.women<-((dim(n.gbl.res.women)[1])/(dim(n.gbl.wCA.res)[1]))*100  #Calculate the % of responses from  female researchers

#Career Stage Tabulations:
#table(n.gbl.wCA.res$what_participant_group)
n.seniorac <- n.gbl.wCA.res[n.gbl.wCA.res$what_participant_group=="Senior academic researcher with >10 years of experience applying for research grants",]
percent.seniorac<-((dim(n.gbl.wCA.res)[1])/(dim(n.gbl.wCA.res)[1]))*100 #Calculate the % of responses from  senior academic researchers
n.earlyac <- n.gbl.wCA.res[n.gbl.wCA.res$what_participant_group=="Early career academic researcher with <10 years experience applying for research grants since completion of PhD",]
percent.earlyac<-((dim(n.earlyac)[1])/(dim(n.gbl.wCA.res)[1]))*100 #Calculate the % of responses from  early academic researchers
n.pdf <- n.gbl.wCA.res[n.gbl.wCA.res$what_participant_group=="Postdoctoral fellow or research assistant with experience applying for research grants, or anticipating the need to apply for grants in the near future",]
percent.pdf<-((dim(n.pdf)[1])/(dim(n.gbl.wCA.res)[1]))*100 #Calculate the % of responses from  post-docs
n.nonACearly <- n.gbl.wCA.res[n.gbl.wCA.res$what_participant_group=="Non-academic researcher conducting or managing research in industry or government with <10 years of experience",]
percent.nonACearly<-((dim(n.nonACearly)[1])/(dim(n.gbl.wCA.res)[1]))*100 #Calculate the % of responses from early career non-academics
n.nonACsenior <- n.gbl.wCA.res[n.gbl.wCA.res$what_participant_group=="Non-academic researcher conducting or managing research in industry or government with >10 years of experience",]
percent.nonACsenior<-((dim(n.nonACsenior)[1])/(dim(n.gbl.wCA.res)[1]))*100 #Calculate the % of responses from early career non-academics
n.unk <- n.gbl.wCA.res[n.gbl.wCA.res$what_participant_group=="",]
percent.unk<-((dim(n.unk)[1])/(dim(n.gbl.wCA.res)[1]))*100 #Calculate the % of responses from unknown career stage

#Discipline Tabulations:
n.natural <- n.gbl.wCA.res[n.gbl.wCA.res$field_research=="Natural Science",]
percent.natural <- ((dim(n.natural)[1])/(dim(n.gbl.wCA.res)[1]))*100 #Calculate the % of responses from  natural scientists
n.physics <- n.gbl.wCA.res[n.gbl.wCA.res$field_research=="Physical Science (eg. math, physics, chemistry, computer science)",]
percent.physics <- ((dim(n.physics)[1])/(dim(n.gbl.wCA.res)[1]))*100 #Calculate the % of responses from  physical scientists
n.med <- n.gbl.wCA.res[n.gbl.wCA.res$field_research=="Medicine and Life Science",]
percent.med <- ((dim(n.med)[1])/(dim(n.gbl.wCA.res)[1]))*100 #Calculate the % of responses from  med/life scientists
n.eng <- n.gbl.wCA.res[n.gbl.wCA.res$field_research=="Engineering",]
percent.eng <- ((dim(n.eng)[1])/(dim(n.gbl.wCA.res)[1]))*100 #Calculate the % of responses from  engineering scientists
n.int <- n.gbl.wCA.res[n.gbl.wCA.res$field_research=="Interdisciplinary Science",]
percent.int <- ((dim(n.int)[1])/(dim(n.gbl.wCA.res)[1]))*100 #Calculate the % of responses from  interdisciplinary scientists
n.ssh <- n.gbl.wCA.res[n.gbl.wCA.res$field_research=="Social Science / Humanities",]
percent.ssh <- ((dim(n.ssh)[1])/(dim(n.gbl.wCA.res)[1]))*100 #Calculate the % of responses from  interdisciplinary scientists

```

**Results**  
In total, `r dim(n.gbl.wCA.res)[1]`  non-Canadian researchers completed the online survey. Of these, almost xxxxx were male (`r ceiling(percent.men)`%) and xxxxx were female (`r round(percent.women)`%); xxxx proportion either did not input their gender or selected other. xxxx of the n.gbl.wCA.res respondents (`r round(sum(percent.seniorac,percent.earlyac))`%) were either senior academics (`r round(percent.seniorac)`%), defined as those researchers with more than ten years experience applying for research grants since completion of their PhD, or early career academics (`r round(percent.earlyac)`%) (Figure 4.1). xxxxx also came from post-doctoral researchers (`r round(percent.pdf)`%), non-academic researchers (`r  round(sum(percent.nonACearly,percent.nonACsenior))`%), or those who did not indicate their career stage (`r round(percent.unk, digits=1)`%).

Researchers from many different disciplines were represented in the n.gbl.wCA.res. Almost xxxx percent of responses came from either the natural or physical sciences (Figure 4.2). The remaining responses were spread amongst the medical and life sciences (`r round(percent.med)`%), engineering (`r round(percent.eng)`%), interdisciplinary research (`r round(percent.int)`%), and social sciences and humanities (`r round(percent.ssh)`%). 

<!-- Generate  career stage figure -->
```{r, echo=FALSE, message=FALSE, fig.cap="Figure 4.1 Number of non-canadian survey respondents by career stage", warning=FALSE, fig.width=14}
...
experience<-data.frame(table(n.gbl.wCA.res$what_participant_group))
...
pdf(file="figures/global/w_out_Canada/4.1_CareerStage.pdf", width = 11, height= 7)
...
ggplot(experience, aes(x = reorder(Var1, -Freq), Freq, fill=Var1)) + 
  ...
  labs(y="Number of responses", x="", title="Responses by career stage (without Canadian responses)") +
...
```{r, echo=FALSE, fig.cap="Figure 4.2 n.gbl.wCA.res responses by field of research", warning=FALSE, fig.width=14}
field<-data.frame(table(n.gbl.wCA.res$field_research))
...
pdf(file="figures/global/w_out_Canada/4.2_FieldofResearch.pdf", width = 11, height= 7)

ggplot(field, aes(x = reorder(Var1, -Freq), Freq, fill=Var1)) + 
    geom_bar(stat='identity',position = position_dodge(width=0.5)) + 
  labs(y="Number of responses",x="", title="Responses by field of research (without Canadian responses)")  +
...
#remove CA responses
research.w.CA <- research[research$nation!="Canada",]


## make sure that Use-inspired is the middle level in the legend
res.plot<-subset(research.w.CA, type%in%c("percent_fundemental_research_current",  "percent_Applied_Research_current" , "percent_Use_inspired_Research_current","percent_Applied_Research_past",  "percent_Fundamental_Research_past" , "percent_Use_inspired_Research_past"))
...
pdf(file="figures/global/w_out_Canada/4.3.1_ResearchProportion.pdf", width = 11, height= 7)
...
ggplot(res.plot, aes(percent, fill=ID)) +
    ...
    labs(x="Percent", y="Number of responses", title="Reseach type by proportion (without Canadian responses)")+
  ...
  scale_x_continuous(breaks=seq(0,100,10))+scale_y_continuous(expand=c(0,0), limits=c(0,275),breaks=c(0,50,100,150, 200,250))
...
p1 <- ggplot(xs$Fundamental,aes(percent, fill=time)) +
  ...
  scale_x_continuous(breaks=seq(0,100,10))+scale_y_continuous(expand=c(0,0), limits=c(0,275),breaks=c(0,100,200,275))

p2 <- p1 %+% xs$`Use-inspired`
p3 <- p1 %+% xs$Applied
p1<-p1+scale_fill_manual(name = "ID",values =mycols[4:5], labels=c("2006-2010", "2011-2015"))+labs(x="", title="Type of research by proportion (without Canadian responses)")+ theme(plot.margin=unit(c(1,1,-0.45,1), "cm"), plot.title = element_text(hjust = 0.5))
...
pdf(file="figures/global/w_out_Canada/4.3.2_ResearchProportion.pdf", width = 11, height= 7)
...
#remove CA responses
research.change.w.CA <- research.change[research.change$nation!="Canada",]


#Change yes or no
yes.no<-subset(research.change.w.CA, select=c("Location","Country", "Country_work",  "gender", "changed_10yrs"))
...
p1<-ggplot(data=global.yes.no, aes(x=changed_10yrs, y=gender, fill=gender))+ geom_bar(stat='identity') + guides(fill=FALSE)+
  theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank(), axis.title.x=element_blank(), plot.title = element_text(hjust = 0.5))+geom_text(aes(label=gender), vjust=-0.5)+labs(y="Number of responses", title="Change in research type\n(without Canadian responses)")+ scale_y_continuous(expand = c(0, 0), limits = c(0,700))+ annotate('text', 0.5,1343, label="(a)", size=5)
  
####reason for change  
reason<-subset(research.change.w.CA, select=c("Location","Country","Country_work",  "gender", "Main_reason_change_interest_related",
...
require(tidyr)
global.long<-gather(reason, reason.change.glb, yes.glb, -Location, -nation, -gender, -Country_work, -Country)
...
p2<-ggplot(sum.global, aes(x=Var1, y=Freq, fill=Var1)) + geom_bar(stat='identity')+ 
  ...
  labs(y="Number of responses", title="Reason for change in research type\n(without Canadian responses)")+
  scale_y_continuous(expand = c(0, 0), limits = c(0, 375))+annotate('text', 5.4,785, label="(b)", size=5)+geom_text(aes(label=Freq), vjust=-0.5, size=3)
...
pdf(file="figures/global/w_out_Canada/4.4a&b_ReasonForFieldChange.pdf", width = 11, height= 7)
...
view.propor<-n.gbl.wCA.res[!n.gbl.wCA.res$view_change_of_type=="",]
...
pdf(file="figures/global/w_out_Canada/4.5_ViewFieldChange.pdf", width = 11, height= 7)
...
ggplot(change.view.glb, aes(x=view_change_of_type, y=gender, fill=view_change_of_type)) + geom_bar(stat='identity')+
  ...
  theme(panel.grid.major = element_blank(),legend.text=element_text(size = 9), panel.grid.minor = element_blank())+ labs(x="", y="Number of responses", title="Opinion of change in research type (without Canadian responses)")+geom_text(aes(label=gender), vjust=-0.5, size=3)+scale_y_continuous(expand = c(0, 0), limits = c(0,200))+scale_fill_manual(name='view_change_of_type', values=myColors5)#+annotate('text', 5.4,133, label="(c)", size=5)
...
b.part<-data.frame(table(n.gbl.wCA.res$partnership_outside_before))
b.part<-b.part[!b.part$Var1=="",]
b.part<-droplevels(b.part)
b.part$time<-"Past"
a.part<-data.frame(table(n.gbl.wCA.res$partnership_outside))
...
pdf(file="figures/global/w_out_Canada/4.6_LevelsOfPartnership.pdf", width = 11, height= 7)
...
ggplot(part, aes(x=Var1, y=Freq, fill = time),  ylim(0,375)) + 
  ...
  labs(x="", y="Number of responses", fill="", title="Level of partnership outside of academia (without Canadian responses)")+
  theme(aspect.ratio=3/4, panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
  ...
  colScale+scale_y_continuous(expand = c(0, 0), limits = c(0,590))
...
change.part.glb<-data.frame(table(n.gbl.wCA.res$partnership_change_10yrs))
...
g1<-ggplot(data=change.part.glb, aes(x=Var1, y=Freq, fill=Var1))+ 
    ...
    guides(fill=FALSE) + 
    labs(x="", y="Number of responses",title="Change in level of external partnerships (without Canadian responses)")+
  geom_text(aes(label=Freq), vjust=-0.5)+
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), plot.title = element_text(hjust = 0.5)) + 
  scale_fill_manual(name = "Var1",values = myColors) +
  #annotate('text', 3.25,606, label="(a)", size=7)+
  scale_y_continuous(expand = c(0, 0), limits = c(0,760))

### reason

#remove CA responses
part2.reason.w.CA <- part2.reason[part2.reason$nation!="Canada",]


reason.pt.long<-gather(part2.reason.w.CA, change.reason, yes, -Country,-Country_work, -nation, -gender, -Location, -what_participant_group, -field_research)
...
g2<-ggplot(sum.global, aes(x=Var1, y=Freq, fill=Var1)) + 
    ...
    theme(axis.text.x = element_text(angle=0, vjust=0.5, size = 9), axis.text.y=element_text(size = 9), axis.title.y=element_text(size = 11),
          ...
          panel.grid.minor = element_blank(), plot.title = element_text(hjust = 0.5)) + 
  geom_text(aes(label=Freq), vjust=-0.5, size=3)+
  labs(x="", y="Number of responses", title="Reason for change in level of external partnerships (without Canadian responses)")+scale_fill_manual(name = "Var1",values = myColors7)+
  scale_y_continuous(expand = c(0, 0), limits = c(0,360))

#annotate('text', 5,420, label="(b)", size=7)+ 

pdf(file="figures/global/w_out_Canada/4.7a&b_PartnershipChange&Reason.pdf", width = 11, height= 7)
...
view<-data.frame(table(n.gbl.wCA.res$view_change_partnership))
view<-view[!view$Var1=="",]
...
pdf(file="figures/global/w_out_Canada/4.8_ViewChangePartnership.pdf", width = 11, height= 7)
...
ggplot(view, aes(x=Var1, y=Freq, fill=Var1)) + geom_bar(stat='identity')+
  ...
  labs(x="", y="Number of responses", title="Opinion of change in level of external partnerships (without Canadian responses)") + colScale+scale_y_continuous(expand = c(0, 0), limits = c(0,175), breaks = seq(0,300,50))
...
part3.grants.long<-read.csv(file="../data/gya-part3.grants.long.csv")
#remove CA responses
part3.grants.long <- part3.grants.long[part3.grants.long$nation!="Canada",]
...
pdf(file="figures/global/w_out_Canada/4.9_NumberGrantApps.pdf", height=7, width =11)
...
p1 <- ggplot(xs$Fundamental, aes(number, Freq, fill=time), width=0.7) + 
  ...
  colScale+scale_y_continuous(expand = c(0, 0), limits = c(0,1000), breaks = c(0,200,400,600,800,1000))
...
grid.arrange(p1,p2,p3, nrow=1, top=textGrob("Number of research grant applications (without Canadian responses)",gp=gpar(fontsize=17)))
...
#remove CA responses
part3.success.long <- part3.success.long[part3.success.long$nation!="Canada",]
...
pdf(file="figures/global/w_out_Canada/4.10_GrantAppSuccess.pdf", height=7, width =11)
...
#remove CA responses
part3.change.w.CA <- part3.change[part3.change$nation!="Canada",]

##switch to long format
change.long.gbl<-gather(part3.change.w.CA, type, level, -Location, -nation, -gender, -Country, -Country_work, -what_participant_group, -field_research)
...
pdf(file="figures/global/w_out_Canada/4.11_ChangeSuccessRate.pdf", height=7, width =11)
...
ggplot(data=success.change, aes(x=level, Freq, fill=type))+ facet_wrap(~type, nrow=3)+
  ...
  labs(x="", y="Number of responses", fill="", title="Change in grant success rate (without Canadian responses)")+ colScale+
...
#remove CA responses
part3.prac.long <- part3.prac.long[part3.prac.long$nation!="Canada",]
...
pdf(file="figures/global/w_out_Canada/4.12_ImportancePracticalApplication.pdf", height=7, width =11)
...
ggplot(prac.gbl, aes(Var2, Freq, fill=Var1)) + 
  ...
  labs(x="Importance of suggesting practical research applications", y="Number of responses", title="Importance of practical application for grant success (without Canadian responses)")+ colScale+
...
#remove CA responses
part3.part.long <- part3.part.long[part3.part.long$nation!="Canada",]
...
pdf(file="figures/global/w_out_Canada/4.13_ImportancePartnersApplication.pdf", height=7, width =11)
...
ggplot(part.gbl, aes(Var2, Freq, fill=Var1))+ 
  geom_bar(stat="identity", position = "dodge")+geom_text(aes(label=Freq), vjust=-0.7, hjust=0.5, size=3, position = position_dodge(width = 0.8))+
    guides(fill=guide_legend(title=NULL, reverse=FALSE)) +
    labs(x="Importance of external partnerships", y="Number of responses", title="Importance of external partnership to the success of grants (without Canadian responses)")+
...
#remove CA responses
p3_master.long <- p3_master.long[p3_master.long$nation!="Canada",]
...
p1<-ggplot(fp, aes(percent, fill=year))+ geom_histogram(position='dodge', binwidth=10)  + colScale +
  ...
  scale_y_continuous(expand =c(0,0), limits=c(0,1300), breaks=seq(0, 1300, 200))+
...
pdf(file="figures/global/w_out_Canada/4.14_DistributionFunding.pdf", height=7, width =11)

grid.arrange(arrangeGrob(p1+ theme(legend.position="none"), p2,
                         p3+ theme(legend.position="none"), p4+ theme(legend.position="none"),
                         p5,
                         layout_matrix=rbind(c(1,1,1,2,2,2),c(3,3,4,4,5,5))), top=textGrob("Distribution of research funding (without Canadian responses)",gp=gpar(fontsize=17)))
...
#remove CA responses
part4.w.CA <- part4[part4$nation!="Canada",]


## order bars from very important (left) to can't comment (right)
important<-subset(part4.w.CA, select=c("Location","Country",'Country_work', "gender","opinion_fundamental_important"))
...
pdf(file="figures/global/w_out_Canada/4.15_PerceivedImportanceFundamentalGovernment.pdf", height=7, width =11)

ggplot(data=perceive, aes(x=Var1, y=Freq, fill=Var1)) + 
      geom_bar(stat='identity', position='dodge')+ 
      labs(x="", y="Number of responses", fill="", title="Perceived importance of fundamental research to their government (without Canadian responses)")+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,465)) + colScale
...
priority<-subset(part4.w.CA, select=c("Location","Country",'nation','Country_work', "gender", "high_priority_fundamental", "high_priority_use_inspired", "high_priority_applied", "high_priority_no_change"))
...
pdf(file="figures/global/w_out_Canada/4.16_PerceivedChangeResearchPriorityGovernment.pdf", height=7, width =11)
...
ggplot(data=per.change, aes(x=what.type, higher.priority, fill=what.type))+
        ...
        theme(aspect.ratio=3/4, 
              ...
              panel.grid.major = element_blank(),
              panel.grid.minor = element_blank(), axis.title.y=element_text(size=11),  axis.text.y=element_text(size=9), plot.title = element_text(hjust = 0.5)) +
        labs(x="", y="Number of responses", fill="", title="Perceived change in research priority by their government (without Canadian responses)") +
  scale_x_discrete(labels=c( "Fundamental", "Use-inspired","Applied", "No change"))   +
  geom_text(aes(label=higher.priority, vjust=-0.5), size=3) +scale_y_continuous(expand = c(0, 0), limits = c(0,1050))+ colScale
...
availability.change<-subset(part4.w.CA, select=c("Location", "Country","nation",'Country_work', "gender", "available_funding_fundamental",  
...
pdf(file="figures/global/w_out_Canada/4.17_AnticipatedChangeFunding.pdf", height=7, width =11)
...
ggplot(data=availability.gbl, aes(x=level, Freq, fill=what.type))+
    ...
    guides(fill=FALSE)+
    labs(x="", y="Number of responses", fill="", title="Anticipated change in funding (without Canadian responses)")+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,560), breaks = seq(0,550,100))
...
## order bars into increase considerably (left) to decrease considerably (right), then no comment at the far right
next.generation<-subset(part4.w.CA, select=c("Location", "Country","Country_work", "gender","next_generation"))
# remove non-response
...
pdf(file="figures/global/w_out_Canada/4.18_EffectNextGeneration.pdf", height=7, width =11)
...
ggplot(data=impact, aes(x=Var1, Freq, fill=Var1))+ 
    geom_bar(stat='identity', position="dodge")  +
        scale_x_discrete(labels=c("Increase\n considerably", "Increase\n slightly", 
                                    "Stay the same", "Decrease\n slightly", "Decrease\n considerably", "Can't\n comment"))+
    guides(fill=FALSE) +
 labs(x="", y="Number of responses", title="Effect of funding changes on the next generation of researchers (without Canadian responses)")+
  ...
  geom_text(aes(label=Freq, vjust=-0.5), size=3)+
  scale_y_continuous(expand = c(0, 0), limits = c(0,450))+colScale
