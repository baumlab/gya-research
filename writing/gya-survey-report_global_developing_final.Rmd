...
#pdf(file="figures/LMI/4.1_FieldofResearch_LMI.pdf", width = 11, height= 7)
...
#pdf(file="figures/LMI/4.2_CareerStage_LMI.pdf", width = 11, height= 7)
...
head(res.plot)
breaks <- c(0, 9.999, 19.999, 29.999, 39.999, 49.999, 59.999, 69.999, 79.999, 89.999, 99.999, 100)
...
p2 <- p1 %+% xs$`Use-inspired`
p3 <- p1 %+% xs$Applied
p1<-p1+scale_fill_manual(name = "ID",values = c('#97CCFF','#42A3FF'), labels=c("2006-2010", "2011-2015"))+labs(x="", title="Type of research by percent (LMI)")+ theme(plot.margin=unit(c(1,1,-0.45,1), "cm"), plot.title = element_text(hjust = 0.5, size = 14))+ scale_y_continuous(expand=c(0,0), limits=c(0,20),breaks=seq(0,20,5))
...
p3<-p3+scale_fill_manual(name = "ID",values =c('#F0A490','#E55934'), labels=c("2006-2010", "2011-2015"))+ theme(plot.margin=unit(c(-0.5,1,1,1), "cm"))+ scale_y_continuous(expand=c(0,0), limits=c(0,45),breaks=seq(0,45,10)) + labs(x = "Percentage of research")
...
#pdf(file="figures/LMI/4.3b_ReasonForFieldChange_LMI.pdf", width = 11, height= 7)
...
ggplot(sum.reason, aes(x=Var1, y=Freq, fill=Var1)) + geom_bar(stat='identity')+ 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 90), breaks = seq(0, 80, 20))#+annotate('text', 5.4,795, label="(b)", size=5)#+geom_text(aes(label=Freq), vjust=-0.5, size=3)
...
#pdf(file="figures/LMI/4.3C_ViewFieldChange_LMI.pdf", width = 11, height= 7)
...
#pdf(file="figures/LMI/4.4A_PerceivedImportanceFundamentalGovernment_LMI.pdf", height=7, width =11)
...
ggplot(data=import, aes(x=Var1, y=Freq, fill=Var1)) + 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,120), breaks = seq(0, 120, 20)) + colScale
...
#pdf(file="figures/LMI/4.4B_PerceivedChangeResearchPriorityGovernment_LMI.pdf", height=7, width =11)
...
#pdf(file="figures/LMI/4.5_ChangeSuccessRate_LMI.pdf", height=7, width =11)
...
ggplot(data=success.change, aes(x=level, Freq, fill=type))+ facet_wrap(~type, nrow=3)+
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,120), breaks = seq(0, 120, 30))
...
#pdf(file="figures/LMI/4.6_DistributionFunding_LMI.pdf", height=7, width =11)
...
#pdf(file="figures/LMI/4.7B_ImportancePartnersApplication_LMI.pdf", height=7, width =11)
...
#pdf(file="figures/LMI/4.8B_PartnershipChange&Reason_LMI.pdf", width = 11, height= 7)
...
#pdf(file="figures/LMI/4.8C_ViewChangePartnership_LMI.pdf", width = 11, height= 7)
...
#pdf(file="figures/LMI/4.9_AnticipatedChangeFunding_LMI.pdf", height=7, width =11)
