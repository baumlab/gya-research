...
pdf(file="figures/LMI/4.2_CareerStage_LMI.pdf", width = 8, height= 10)
...
#pdf(file="figures/LMI/4.4A_PerceivedImportanceFundamentalGovernment_LMI.pdf", height=8, width =7)
...
ggplot(data=import, aes(x=Var1, y=Freq, fill=Var1)) + 
      ...
      labs(x="", y="Number of respondents", fill="", title="Perceived importance of fundamental research to their government (LMI)")+
...
#pdf(file="figures/LMI/4.4B_PerceivedChangeResearchPriorityGovernment_LMI.pdf", height=8, width =7)
...
ggplot(data=sum.priority, aes(x=Var1, Freq, fill=Var1))+
        ...
        labs(x="", y="Number of respondents", fill="", title="Perceived change in research priority by their government (LMI)") +
...
#pdf(file="figures/LMI/4.7A_ImportancePracticalApplication_LMI_percent.pdf", height=8, width =7)
#svg(file="figures/LMI/4.7A_ImportancePracticalApplication_LMI.svg", width = 11, height= 7)
...
ggplot(prac.perc.l, aes(opinion, percent, fill=year)) + 
  ...
  guides(fill=guide_legend(title=NULL, reverse=FALSE)) + 
  scale_x_discrete(labels=c("Mandatory", "Very\n important","Quite\n important", 'Somewhat\n important', 'Not at all\n important', "Can't\n comment"))+
  labs(x="", y="Percent of responses", title="Importance of practical application of research for grant success (LMI)")+ colScale7+
...
#pdf(file="figures/LMI/4.7B_ImportancePartnersApplication_LMI_percent.pdf", height=8, width =7)
#svg(file="figures/LMI/4.7B_ImportancePartnersApplication_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/LMI/4.8A_LevelsOfPartnership_LMI_percent.pdf", width = 7, height= 8)
#svg(file="figures/LMI/4.8A_LevelsOfPartnership_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/LMI/4.8B_PartnershipChange&Reason_LMI.pdf", width = 7, height= 11)
...
#pdf(file="figures/LMI/4.8C_ViewChangePartnership_LMI.pdf", width = 7, height= 8)
...
#pdf(file="figures/LMI/4.10_EffectNextGeneration_LMI.pdf", height=8, width =7)
...
ggplot(data=future, aes(x=Var1, Freq, fill=Var1))+ 
    geom_bar(stat='identity', position="dodge")  +
        scale_x_discrete(labels=c("Increase\nconsiderably", "Increase\nslightly", 
                                    "Stay the\nsame", "Decrease\nslightly", "Decrease\nconsiderably", "Can't\ncomment"))+
    guides(fill=FALSE) +
 labs(x="", y="Number of respondents", title="Effect of funding changes on the next generation of researchers (LMI)")+
  theme(axis.text.x=element_text(size=22, color = "black"),
         axis.text.y=element_text(size = 22, color = "black"),
       panel.grid.major.y = element_line(linetype = 3, color = "darkgrey", size = .3),
        panel.grid.major.x = element_blank(),
