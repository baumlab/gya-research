...
ggsave("4.7B_ImportancePartnersApplication_LMI_percent_Aug2022.svg", plot = f4.7b, device = "svg", path = "figures/LMI", height = 7, width  = 13 , units = "in", dpi = 500)
