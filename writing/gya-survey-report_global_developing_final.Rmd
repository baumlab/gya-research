...
#pdf(file="figures/developing_final/4.1_FieldofResearch_LMI.pdf", width = 11, height= 7)
#svg(file="figures/developing_final/4.1_FieldofResearch_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/developing_final/4.2_CareerStage_LMI.pdf", width = 11, height= 7)
#svg(file="figures/developing_final/4.2_CareerStage_LMI.svg", width = 11, height= 7)
...
p3 <- p1 %+% xs$Applied
p1<-p1+scale_fill_manual(name = "ID",values = c('#97CCFF','#42A3FF'), labels=c("Data/2006-2010", "Data/2011-2015"))+labs(x="", title="Type of research by proportion (LMI)")+ theme(plot.margin=unit(c(1,1,-0.45,1), "cm"), plot.title = element_text(hjust = 0.5, size = 14))+ scale_y_continuous(expand=c(0,0), limits=c(0,40),breaks=seq(0,40,20))
p2<-p2+scale_fill_manual(name = "ID",values =c('#C8DF95','#9BC53D'), labels=c("Data/2006-2010", "Data/2011-2015"))+labs(x="")+ theme(plot.margin=unit(c(-0.25,1,-0.3,1), "cm")) + scale_y_continuous(expand=c(0,0), limits=c(0,80),breaks=seq(0,80,20))
p3<-p3+scale_fill_manual(name = "ID",values =c('#F0A490','#E55934'), labels=c("Data/2006-2010", "Data/2011-2015"))+ theme(plot.margin=unit(c(-0.5,1,1,1), "cm"))+ scale_y_continuous(expand=c(0,0), limits=c(0,100),breaks=seq(0,100,20))


#pdf(file="figures/developing_final/4.3_ResearchProportion_LMI.pdf", width = 11, height= 7)
#svg(file="figures/developing_final/4.3_ResearchProportion_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/developing_final/4.3b_ReasonForFieldChange_LMI.pdf", width = 11, height= 7)
#svg(file="figures/developing_final/4.3b_ReasonForFieldChange_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/developing_final/4.3C_ViewFieldChange_LMI.pdf", width = 11, height= 7)
#svg(file="figures/developing_final/4.3C_ViewFieldChange_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/developing_final/4.4A_PerceivedImportanceFundamentalGovernment_LMI.pdf", height=7, width =11)
#svg(file="figures/developing_final/4.4A_PerceivedImportanceFundamentalGovernment_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/developing_final/4.4B_PerceivedChangeResearchPriorityGovernment_LMI.pdf", height=7, width =11)
#svg(file="figures/developing_final/4.4B_PerceivedChangeResearchPriorityGovernment_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/developing_final/4.5_ChangeSuccessRate_LMI.pdf", height=7, width =11)
#svg(file="figures/developing_final/4.5_ChangeSuccessRate_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/developing_final/4.6_DistributionFunding_LMI.pdf", height=7, width =11)
#svg(file="figures/developing_final/4.6_DistributionFunding_LMI.svg", width = 11, height= 7)
...
```{r 4.7, echo=FALSE, message=FALSE, warning=FALSE}
...
#pdf(file="figures/developing_final/4.7A_ImportancePracticalApplication_LMI.pdf", height=7, width =11)
#svg(file="figures/developing_final/4.7A_ImportancePracticalApplication_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/developing_final/4.7B_ImportancePartnersApplication_LMI.pdf", height=7, width =11)
#svg(file="figures/developing_final/4.7B_ImportancePartnersApplication_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/developing_final/4.8A_LevelsOfPartnership_LMI.pdf", width = 11, height= 7)
#svg(file="figures/developing_final/4.8A_LevelsOfPartnership_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/developing_final/4.8B_PartnershipChange&Reason_LMI.pdf", width = 11, height= 7)
#svg(file="figures/developing_final/4.8B_PartnershipChange_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/developing_final/4.8C_ViewChangePartnership_LMI.pdf", width = 11, height= 7)
#svg(file="figures/developing_final/4.8C_ViewChangePartnership_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/developing_final/4.9_AnticipatedChangeFunding_LMI.pdf", height=7, width =11)
#svg(file="figures/developing_final/4.9_AnticipatedChangeFunding_LMI.svg", width = 11, height= 7)
...
#pdf(file="figures/developing_final/4.10_EffectNextGeneration_LMI.pdf", height=7, width =11)
#svg(file="figures/developing_final/4.10_EffectNextGeneration_LMI.svg", width = 11, height= 7)
