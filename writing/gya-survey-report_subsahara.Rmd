...
#pdf(file="figures/subsahara/responses_country_9Mar18.pdf", width = 11, height= 8)
...
```{r echo=FALSE, fig.cap="Figure 4.1 Number of  survey respondents by career stage", message=FALSE, warning=FALSE}
...
```{r echo=FALSE, fig.cap="Figure 4.2 Survey responses by field of research", message=FALSE, warning=FALSE}
...
#pdf(file="figures/subsahara/4.5_ViewFieldChange.pdf", width = 11, height= 7)
...
#pdf(file="figures/subsahara/4.6_LevelsOfPartnership.pdf", width = 11, height= 7)
...
#pdf(file="figures/subsahara/4.7a&b_PartnershipChange&Reason.pdf", width = 11, height= 7)
...
#pdf(file="figures/subsahara/4.8_ViewChangePartnership.pdf", width = 11, height= 7)
...
grants.sub<-data.frame(with(part3.grants.long, table(type.grant,time,number)))
...
#pdf(file="figures/subsahara/4.9_NumberGrantApps.pdf", height=7, width =11)
...
success.sub<-data.frame(with(part3.success.long, table(type, percent,time)))
...
#pdf(file="figures/subsahara/4.10_GrantAppSuccess.pdf", height=7, width =11)
...
##switch to long format
change.long.sub<-gather(part3.change, type, level, -Location, -gender, -Country,-nation, -Country_work, -what_participant_group, -field_research)
success.change<-with(change.long.sub, data.frame(table(type, level)))
#remove no response
...
#pdf(file="figures/subsahara/4.11_ChangeSuccessRate.pdf", height=7, width =11)
...
prac.sub<-data.frame(table(part3.prac.long$year, part3.prac.long$level))
...
#pdf(file="figures/subsahara/4.12_ImportancePracticalApplication.pdf", height=7, width =11)
...
part.sub<-data.frame(table(part3.part.long$year, part3.part.long$level))
#change order of levels
...
#pdf(file="figures/subsahara/4.13_ImportancePartnersApplication.pdf", height=7, width =11)
...
#pdf(file="figures/subsahara/4.14_DistributionFunding.pdf", height=7, width =11)
...
#pdf(file="figures/subsahara/4.15_PerceivedImportanceFundamentalGovernment.pdf", height=7, width =11)
...
#pdf(file="figures/subsahara/4.16_PerceivedChangeResearchPriorityGovernment.pdf", height=7, width =11)
...
## switch to long format
availability.change.long.sub<-gather(availability.change, what.type, level, -gender, -Location, -Country, -Country_work)
...
#pdf(file="figures/subsahara/4.17_AnticipatedChangeFunding.pdf", height=7, width =11)
...
#pdf(file="figures/subsahara/4.18_EffectNextGeneration.pdf", height=7, width =11)
