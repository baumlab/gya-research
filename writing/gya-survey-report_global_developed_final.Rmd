...
```{r eval=FALSE, fig.cap="Figure 4.1 Number of survey respondents from developed nations by career stage", fig.width=14, message=FALSE, warning=FALSE, include=FALSE}
...
ggplot(field, aes(x = reorder(Var1, -Freq), Freq, fill=Var1)) + 
  ...
  labs(y="Number of responses",x="", title="Responses by field of research (HI)")  +
  ...
  theme(axis.text.y=element_text(size=12),
         axis.text.x=element_text(angle=-45, hjust = 0.1, size=12),
