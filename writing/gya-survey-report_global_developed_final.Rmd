...
#pdf(file="figures/HI/4.1_FieldofResearch_HI.pdf", width = 10, height=11)
#svg(file="figures/HI/4.1_FieldofResearch_HI.svg", width = 11, height= 7)
...
#pdf(file="figures/HI/4.2_CareerStage_HI.pdf", width = 7, height= 8)
...
p3 <- p1 %+% xs$Applied
p1<-p1+scale_fill_manual(name = "ID",values = c('#97CCFF','#42A3FF'), labels=c("2006-2010", "2011-2015"))+labs(x="", title="Type of research by proportion (HI)")+ theme(plot.margin=unit(c(1,1,-0.45,1), "cm"), plot.title = element_text(hjust = 0.5, size = 14))+ scale_y_continuous(expand=c(0,0), limits=c(0,330),breaks=seq(0,300,100))
...
p3<-p3+scale_fill_manual(name = "ID",values =c('#F0A490','#E55934'), labels=c("2006-2010", "2011-2015"))+ theme(plot.margin=unit(c(-0.5,1,1,1), "cm"))+ scale_y_continuous(expand=c(0,0), limits=c(0,680),breaks=seq(0,600,200))
...
p2 <- p1 %+% xs$`Use-inspired`
p3 <- p1 %+% xs$Applied
p1<-p1+scale_fill_manual(name = "ID",values = c('#97CCFF','#42A3FF'), labels=c("2006-2010", "2011-2015"))+labs(x="", title="Type of research by percent (HI)")+ theme(plot.margin=unit(c(1,1,-0.45,1), "cm"), plot.title = element_text(hjust = 0.5, size = 14))+ scale_y_continuous(expand=c(0,0), limits=c(0,25.5),breaks=seq(0,25,5))
p2<-p2+scale_fill_manual(name = "ID",values =c('#C8DF95','#9BC53D'), labels=c("2006-2010", "2011-2015"))+labs(x="")+ theme(plot.margin=unit(c(-0.25,1,-0.3,1), "cm")) + scale_y_continuous(expand=c(0,0), limits=c(0,40.5),breaks=seq(0,40,10))
...
#pdf(file="figures/HI/4.3C_ViewFieldChange_HI.pdf", width = 7, height= 8)
...
#pdf(file="figures/HI/4.4A_PerceivedImportanceFundamentalGovernment_HI.pdf", height=8, width =7)
...
#pdf(file="figures/HI/4.4B_PerceivedChangeResearchPriorityGovernment.pdf", height=8, width =7)
...
#pdf(file="figures/HI/4.6_DistributionFunding_HI_percentnarrow.pdf", height=11, width =7)
...
#pdf(file="figures/HI/4.7A_ImportancePracticalApplication_HI_percent.pdf", height=8, width =7)
...
ggplot(prac.perc.l, aes(opinion, percent, fill=year)) + 
  ...
  guides(fill=guide_legend(title=NULL, reverse=FALSE)) + 
  scale_x_discrete(labels=c("Mandatory", "Very\n important","Quite\n important", 'Somewhat\n important', 'Not at all\n important', "Can't\n comment"))+
  labs(x="", y="Percent of responses", title="Importance of practical application of research for grant success (HI)")+ colScale7+
...
pdf(file="figures/HI/4.7B_ImportancePartnersApplication_HI_percent.pdf", height=8, width =7)
...
#pdf(file="figures/HI/4.8A_LevelsOfPartnership.pdf", width = 11, height= 7)
...
#pdf(file="figures/HI/4.8A_LevelsOfPartnership_HI_percent.pdf", width = 7, height= 8)
...
ggplot(partlevel.perc.l, aes(x=level, y=percent, fill = year),  ylim(0,375)) + 
  ...
  theme(panel.grid.major.y = element_line(linetype = 3, color = "darkgrey", size = .3),
        ...
        legend.position=c(0.1, 0.9), 
        legend.title=element_blank(), plot.title = element_text(hjust = 0.5, size = 14)) +
  colScale7+scale_y_continuous(expand = c(0, 0), limits = c(0,51))
...
#pdf(file="figures/HI/4.8B_PartnershipChange&Reason.pdf", width = 7, height= 11)
...
#pdf(file="figures/HI/4.8C_ViewChangePartnership.pdf", width = 7, height= 8)
...
#pdf(file="figures/HI/4.9_AnticipatedChangeFunding.pdf", height=11, width =7)
...
ggplot(data=ant, aes(x=Var2, Freq, fill=Var1))+
  ...
  colScale9 +
  scale_y_continuous(expand = c(0, 0), limits = c(0,601), breaks = seq(0,600,100))
...
#pdf(file="figures/HI/4.10_EffectNextGeneration.pdf", height=8, width =7)
