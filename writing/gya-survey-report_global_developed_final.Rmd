...
#pdf(file="figures/HI/4.1_FieldofResearch_HI.pdf", width = 11, height= 7)
...
#pdf(file="figures/HI/4.2_CareerStage_HI.pdf", width = 11, height= 7)
...
p2 <- p1 %+% xs$`Use-inspired`
p3 <- p1 %+% xs$Applied
p1<-p1+scale_fill_manual(name = "ID",values = c('#97CCFF','#42A3FF'), labels=c("2006-2010", "2011-2015"))+labs(x="", title="Type of research by percent (HI)")+ theme(plot.margin=unit(c(1,1,-0.45,1), "cm"), plot.title = element_text(hjust = 0.5, size = 14))+ scale_y_continuous(expand=c(0,0), limits=c(0,25),breaks=seq(0,25,5))
p2<-p2+scale_fill_manual(name = "ID",values =c('#C8DF95','#9BC53D'), labels=c("2006-2010", "2011-2015"))+labs(x="")+ theme(plot.margin=unit(c(-0.25,1,-0.3,1), "cm")) + scale_y_continuous(expand=c(0,0), limits=c(0,40),breaks=seq(0,40,10))
p3<-p3+scale_fill_manual(name = "ID",values =c('#F0A490','#E55934'), labels=c("2006-2010", "2011-2015"))+ theme(plot.margin=unit(c(-0.5,1,1,1), "cm"))+ scale_y_continuous(expand=c(0,0), limits=c(0,55),breaks=seq(0,55,10)) + labs(x = "Percentage of research")
...
#pdf(file="figures/HI/4.3b_ReasonForFieldChange_HI.pdf", width = 11, height= 7)
...
#pdf(file="figures/HI/4.3C_ViewFieldChange_HI.pdf", width = 11, height= 7)
...
#pdf(file="figures/HI/4.4A_PerceivedImportanceFundamentalGovernment_HI.pdf", height=7, width =11)
...
#pdf(file="figures/HI/4.4B_PerceivedChangeResearchPriorityGovernment.pdf", height=7, width =11)
...
#pdf(file="figures/HI/4.5_ChangeSuccessRate_HI.pdf", height=7, width =11)
...
#pdf(file="figures/HI/4.6_DistributionFunding_HI.pdf", height=7, width =11)
...
#pdf(file="figures/HI/4.8B_PartnershipChange&Reason.pdf", width = 11, height= 7)
...
#pdf(file="figures/HI/4.8C_ViewChangePartnership.pdf", width = 11, height= 7)
...
#pdf(file="figures/HI/4.9_AnticipatedChangeFunding.pdf", height=7, width =11)
