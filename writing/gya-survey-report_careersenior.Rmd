...
#pdf(file="figures/senior/responses_country_1Mar18.pdf", width = 11, height= 8)
...
#pdf(file="figures/senior/responses_country_gapplot_1Mar18.pdf", height=8, width=11)

par(mar=c(11,4,4,2))
gap.barplot(sort(locations$gender,decreasing=TRUE), gap=c(260,799),horiz=F, xaxlab=barlabs, xlab="     ", 
            ylab="Number of responses", ytics=c(0,50,100,150,200,250, 869), main = "Responses by country",las=2, col=c(blue2red(29)))
...
#pdf(file="figures/senior/responses_country_10+_gapplot_1Mar18.pdf", height=8, width=11)

par(mar=c(7,4,4,2))
gap.barplot(sort(locations.more$gender,decreasing=TRUE), gap=c(260,799),horiz=F, xaxlab=barlabs, xlab="     ", 
            ylab="Number of responses", ytics=c(0,50,100,150,200,250, 869), main = "Countries with greater than 10 responses",las=2, col=color1)
...
color1<-c('#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4')
#pdf(file="figures/senior/responses_country_10+&10-_gapplot_1Mar18.pdf", height=8, width=15)
