...
#pdf(file="figures/senior/4.3.2_ResearchProportion.pdf", width = 11, height= 7)
...
#pdf(file="figures/senior/4.4a&b_ReasonForFieldChange.pdf", width = 11, height= 7)
...
#pdf(file="figures/senior/4.5_ViewFieldChange.pdf", width = 11, height= 7)
...
#pdf(file="figures/senior/4.6_LevelsOfPartnership.pdf", width = 11, height= 7)
...
#pdf(file="figures/senior/4.7a&b_PartnershipChange&Reason.pdf", width = 11, height= 7)
...
#pdf(file="figures/senior/4.8_ViewChangePartnership.pdf", width = 11, height= 7)
...
grants.gbl.senior<-data.frame(with(part3.grants.long, table(type.grant,time,number)))
...
#pdf(file="figures/senior/4.9_NumberGrantApps.pdf", height=7, width =11)
...
success.gbl.senior<-data.frame(with(part3.success.long, table(type, percent,time)))
...
#pdf(file="figures/senior/4.10_GrantAppSuccess.pdf", height=7, width =11)
...
##switch to long format
change.long.gbl.senior<-gather(part3.change, type, level, -Location, -gender, -Country,-nation, -Country_work, -what_participant_group, -field_research)
...
#pdf(file="figures/senior/4.11_ChangeSuccessRate.pdf", height=7, width =11)
...
prac.gbl.senior<-data.frame(table(part3.prac.long$year, part3.prac.long$level))
...
#pdf(file="figures/senior/4.12_ImportancePracticalApplication.pdf", height=7, width =11)
...
part.gbl.senior<-data.frame(table(part3.part.long$year, part3.part.long$level))
#change order of levels
...
#pdf(file="figures/senior/4.13_ImportancePartnersApplication.pdf", height=7, width =11)
...
#pdf(file="figures/senior/4.14_DistributionFunding.pdf", height=7, width =11)
...
#pdf(file="figures/senior/4.15_PerceivedImportanceFundamentalGovernment.pdf", height=7, width =11)
...
#pdf(file="figures/senior/4.16_PerceivedChangeResearchPriorityGovernment.pdf", height=7, width =11)
...
#pdf(file="figures/senior/4.17_AnticipatedChangeFunding.pdf", height=7, width =11)
...
#pdf(file="figures/senior/4.18_EffectNextGeneration.pdf", height=7, width =11)
