...
To extract survey responses for Israeli researchers, we selected all respondents who reported 'Israel' as their country of work, as well as those respondents who did not report a country of work (i.e. field was blank) but whose location was within Israel. 
...
pdf(file="figures/israel/4.1_CareerStage.pdf", width = 11, height= 7)
...
pdf(file="figures/israel/4.2_FieldofResearch.pdf", width = 11, height= 7)
...
p2<-ggplot(sum.israel, aes(x=Var1, y=Freq, fill=Var1)) + geom_bar(stat='identity')+ 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,42))+annotate('text', 5.4,420, label="(b)", size=5)+geom_text(aes(label=Freq), vjust=-0.5, size=3)
  

pdf(file="figures/israel/4.4_ReasonForFieldChange.pdf", width = 11, height= 7)
...
pdf(file="figures/israel/4.5_ViewFieldChange.pdf", width = 11, height= 7)
...
pdf(file="figures/israel/4.6_LevelsOfPartnership.pdf", width = 11, height= 7)
...
```{r, echo=FALSE, fig.cap="Figure 4.7 Did it change and reasons for change in level of external research partnerships over the past decade.", warning=FALSE}
### was there change
...
pdf(file="figures/israel/4.8_ViewChangePartnership.pdf", width = 11, height= 7)
...
pdf(file="figures/israel/4.11_ChangeSuccessRate.pdf", height=7, width =11)
...
pdf(file="figures/israel/4.12_ImportancePracticalApplication.pdf", height=7, width =11)
...
pdf(file="figures/israel/4.13_ImportancePartnersApplication.pdf", height=7, width =11)
...
```{r, echo=FALSE, fig.cap="Fig 4.15 Perceived importance of fundamental research to Israeli government. Researchers were asked how important they thought fundamental research was to the Israeli government. Responses were/were not significantly different between genders."}
...
pdf(file="figures/israel/4.15_PerceivedImportanceFundamentalGovernment.pdf", height=7, width =11)
...
```{r, echo=FALSE, fig.cap="Fig 4.16 Perceived change in research priority by Israeli government. Researchers were asked whether any types of research had become higher priority for the Israeli government. Responses were/were not significantly different between genders."}
...
pdf(file="figures/israel/4.16_PerceivedChangeResearchPriorityGovernment.pdf", height=7, width =11)
...
pdf(file="figures/israel/4.17_AnticipatedChangeFunding.pdf", height=7, width =11)
...
pdf(file="figures/israel/4.18_EffectNextGeneration.pdf", height=7, width =11)
