...
pdf(file = "Figures/4.1a_29May.pdf", width = 11, height = 8)
...
p14<-ggplot(data=per.change, aes(x=what.type, higher.priority, fill=what.type))+
  ...
  geom_text(aes(label=higher.priority, vjust=-0.5), size=3) +scale_y_continuous(expand = c(0, 0), limits = c(0,1260))+ colScale+annotate('text', 0.6,1200, label="(b)", size=5)+ theme(plot.margin=unit(c(1,1,1,-1), "cm"))
p14

#pdf(file="figures/4.5_13Apr.pdf", width = 11, height = 7)

#grid.arrange(p13, p14, nrow=1,widths=c(0.535,0.465))
g13.14<-arrangeGrob(p13,p14,nrow=1,widths=c(0.535,0.465) )


ggsave("figures/4.5_25May17.pdf",g13.14, width = 6.4, height = 2.25, units = "in", scale=2)
...
```{r, echo=FALSE, fig.cap="Fig 4.17 (now 4.7) Anticipated change in research funding in next five years in Canada. Researchers were asked whether the availability of research funding would change in the next five years, for each research category. Responses were/were not significantly different between genders. "}
...
pdf(file="figures/4.17_May29.pdf", height=7, width =11)
