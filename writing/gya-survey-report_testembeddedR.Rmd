...
p1 <- ggplot(xs$Fundamental,aes(percent, fill=time)) +
    ...
    theme(panel.grid.major = element_blank(),
          ...
          strip.background = element_rect(colour="white", fill="white"),
          legend.position=c(0.92, 0.86), legend.spacing=unit(100,"cm")) + 
    facet_wrap(~type, nrow=3) +
  scale_x_continuous(breaks=seq(0,100,10))+scale_y_continuous(expand=c(0,0), limits=c(0,300),breaks=c(0,100,200,300))

p2 <- p1 %+% xs$`Use-inspired`
p3 <- p1 %+% xs$Applied
p1<-p1+scale_fill_manual(name = "ID",values =mycols[4:5], labels=c("2006-2010", "2011-2015"))
p2<-p2+scale_fill_manual(name = "ID",values =mycols[c(6,1)], labels=c("2006-2010", "2011-2015"))
p3<-p3+scale_fill_manual(name = "ID",values =mycols[2:3], labels=c("2006-2010", "2011-2015"))

grid.arrange(p1,p2,p3, left= textGrob("(a)", gp = gpar(fontsize=14), y=0.98, hjust = -.75))
...
p1 <- ggplot(xs$Fundamental,aes(percent, fill=time)) +
    ...
    theme(panel.grid.major = element_blank(),
          ...
          strip.text.x = element_text(size=12, face="bold", color="black"),
          strip.background = element_rect(colour="white", fill="white"),
          legend.position=c(0.90, 0.81), legend.spacing=unit(100,"cm")) + 
    facet_wrap(~type, nrow=3) +
  scale_x_continuous(breaks=seq(0,100,10))+scale_y_continuous(expand=c(0,0), limits=c(0,300),breaks=c(0,100,200,300))
...
p2<-p2+scale_fill_manual(name = "ID",values =mycols[c(6,1)], labels=c("2006-2010", "2011-2015"))
p3<-p3+scale_fill_manual(name = "ID",values =mycols[2:3], labels=c("2006-2010", "2011-2015"))
g1<-grid.arrange(p1,p2,p3, left= textGrob("(a)", gp = gpar(fontsize=12), y=0.96))
...
p4<-ggplot(part, aes(x=Var1, y=Freq, fill = time),  ylim(0,375)) + 
  ...
  theme(panel.grid.major = element_blank(),
        ...
        legend.title=element_blank()) +
  colScale+scale_y_continuous(expand = c(0, 0), limits = c(0,350))+scale_x_discrete(limits = rev(levels(part$Var1)))+annotate('text', 0.5,337, label="(a)", size=5)
p4
...
p5<-ggplot(sum.canada, aes(x=Var1, y=Freq, fill=Var1)) + 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,450))+annotate('text', 5.3,431, label="(b)", size=5)
p5
...
p6<-ggplot(view, aes(x=Var1, y=Freq, fill=Var1)) + geom_bar(stat='identity')+
  ...
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        axis.text.x = element_text(angle=0, vjust=0, size=9), axis.text.y=element_text(size = 9), axis.title.y=element_text(size=11)) + 
  labs(x="", y="") + colScale + scale_y_continuous(expand = c(0, 0), limits = c(0,165 ), breaks = seq(0,160,40))+scale_x_discrete(limits = rev(levels(view$Var1)))+annotate('text', 0.65,158, label="(c)", size=5)+scale_x_discrete(labels=c("Very\nnegative", "Slightly\nnegative", 
                                    "Neutral", "Slightly\npositive", "Very\npositive"))
p6


#put them all together
pdf(file="figures/4.2_12Apr.pdf")
...
pdf(file="figures/4.10(appendix)_12Apr.pdf", height=7, width =11)
...
pdf(file="figures/4.3_12Apr.pdf", width = 11, height= 7)
...
p13<-ggplot(data=perceive, aes(x=Var1, y=Freq, fill=Var1)) + 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0,550)) + colScale+annotate('text', 0.6,525, label="(a)", size=5)
p13
...
p14<-ggplot(data=per.change, aes(x=what.type, higher.priority, fill=what.type))+
  ...
  geom_text(aes(label=higher.priority, vjust=-0.5), size=3) +scale_y_continuous(expand = c(0, 0), limits = c(0,1260))+ colScale+annotate('text', 0.6,1200, label="(b)", size=5)
p14

pdf(file="figures/4.5_12Apr.pdf", width = 11, height = 7)
