...
mycols<-c('#1f78b4','#a6cee3','#33a02c','#b2df8a','#e31a1c', '#fb9a99')
...
myColors10<-(brewer.pal(9, "Blues"))
myColors10<-rev(myColors10[c(9, 5)])
colScale <- scale_fill_manual(name = "time",values = myColors10)
  ...
  facet_wrap(~type, nrow=2, scales = "free_y") + colScale +
   guides(fill=guide_legend(title=NULL)) +
    theme(legend.position=c(0.922, 0.98),
          ...
          panel.grid.minor = element_blank(), axis.text.x=element_text(size = 9), axis.text.y=element_text(size = 9),
