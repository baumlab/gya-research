...
pdf(file="figures/4.1and4.2(old)_CareerStageAndFieldOfResearch_28may.pdf", width = 11, height= 7)
...
pdf(file = "Figures/4.1a_1Jun.pdf", width = 11, height = 8)
...
ggsave("figures/4.2_FieldofResearch_28May17.pdf",g2.3, width = 6.4, height = 2.25, units = "in", scale=2)
...
pdf(file="figures/4.2_1June.pdf")
...
pdf(file="figures/4.4_29May_2.pdf", height=7, width =11)
...
pdf(file="figures/4.14(appendix)_31May.pdf", height=7, width =11)
...
ggsave("figures/4.5_1Jun17.pdf",g13.14, width = 6.4, height = 2.25, units = "in", scale=2)
...
pdf(file="figures/4.17_1Jun.pdf", height=7, width =11)
...
ggsave("figures/4.18_25May17.pdf", width = 6.4, height = 2.4, units = "in", scale=2)
```
