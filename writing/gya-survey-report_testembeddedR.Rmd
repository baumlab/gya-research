...
```{r, echo=FALSE, fig.cap="Fig 4.4 Importance of practical applications and external partnerships. (4.12 + 4.13)", warning=FALSE}
###4.12
myColors12<-(brewer.pal(9, "Blues"))
myColors12<-rev(myColors12[c(9, 5)])
colScale <- scale_fill_manual(name = "Var1",values = myColors12)
...
```{r, echo=FALSE, fig.cap="Fig 4.5 Anticipated future of research funding."  - 4.15 + 4.16}
