...
The majority of surveys were completed by researchers based in Canada (n = `r country_work$gender[country_work$Country_work=="Canada"]`), followed by Israel (n = `r country_work$gender[country_work$Country_work=="Israel"]`) then by USA (n = `r country_work$gender[country_work$Country_work=="United States"]`) and the UK (n = `r country_work$gender[country_work$Country_work=="United Kingdom"]`). `r country_work$gender[country_work$Country_work==""]` surveys did not identify their place of work.
