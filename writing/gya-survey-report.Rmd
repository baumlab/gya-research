...
#ggplot(res.plot[res.plot$Country=="Canada",], aes( y=percent, fill=time)) + 
#    geom_histogram(stat='identity',position='dodge', binwidth=10, bins=seq(0, 100, 10))  +
#    guides(fill=guide_legend(title=NULL, reverse=FALSE, nrow=2)) +
#    labs(x="Research type", y="% research", title="")+
