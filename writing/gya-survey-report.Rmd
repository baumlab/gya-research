...
```{r, echo=FALSE, fig.cap="Survey responses by field of research", warning=FALSE}
...
ggplot(field.can, aes(x = reorder(field_research, -Freq), Freq, fill=field_research)) +         geom_bar(stat='identity',position = position_dodge(width=0.5)) + 
  ylim(c(0, 310)) +
...
```{r, echo=FALSE, fig.cap="Survey responses by years of experience", warning=FALSE}
## setting colour scale to keep colours identical between similar plots
...
ggplot(experience_can, aes(x = reorder(Var1, -Freq), Freq, fill=Var1)) + 
  ...
  theme(legend.title=element_blank(), 
        ...
        panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank()) + 
  colScale+ ylim(c(0, 1200)) + guides(fill=FALSE)
