...
write.csv(locations, file="data/country_responses_20Sept17.csv", row.names = FALSE)
...
pdf(file="figures/global/responses_country_20Sept17.pdf", width = 11, height= 8)
...
pdf(file="figures/global/responses_country_gapplot_20Sept17.pdf", height=8, width=11)
...
pdf(file="figures/global/responses_country_10+_gapplot_20Sept17.pdf", height=8, width=11)
...
color1<-c('#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4','#1f78b4')
pdf(file="figures/global/responses_country_10+&10-_gapplot_20Sept17.pdf", height=8, width=15)
