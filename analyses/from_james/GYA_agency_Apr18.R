...
pdf(file="figures/GYA_agencydata_3.1_4panels_apr18_2017.pdf", height=7, width=11)
...
#print(grid.arrange(g1, g2, g3, nrow=3))
print(grid.arrange(n1, n2, n3, n4, nrow=4))
...
pdf(file="figures/GYA_agencydata_3.2_4panels_apr18_2017.pdf", height=7, width=11)
...
s3<-ggplot(dat2[dat2$panel=='bot',], aes(Year, value, col=Type, group=Type)) + 
  ...
  scale_y_continuous(labels=comma)+
  scale_colour_manual(values=c(brewer.pal(2, name="Paired")))+
    annotate("text", "2005", 3800, label="(c)", hjust=3) +
  # facet_wrap(~Type, scales="free")+
  guides(col=FALSE)
...
pdf(file="figures/GYA_agencydata_3.3_apr17_2017.pdf", height=7, width=11)
