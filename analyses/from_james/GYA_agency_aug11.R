...
## read in data
dat1<-read.csv("data/part5-international-july/aug11/NSERC_grants.csv", check.names=FALSE)
dat2<-read.csv("data/part5-international-july/aug11/SSHRC_grants.csv", check.names=FALSE)
...
dat5<-read.csv("data/part5-international-july/aug11/CIHR_grants.csv", check.names=FALSE)
...
pdf(file="figures/GYA_agencydata_aug11_2016.pdf", height=7, width=11)
