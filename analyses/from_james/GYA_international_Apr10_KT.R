...
topten<-c( "Israel", "South Korea", "Japan", "Finland", "Sweden", "Taiwan", "Denmark", "Germany", "Austria", 'OECD Average')
...
## load in data
gerd<-read.csv("data/from_James/part5-international-july/aug5/GERD_gross_10Apr.csv", header=TRUE, stringsAsFactors=TRUE, check.names=FALSE)
gerd.source<-read.csv("data/from_James/part5-international-july/aug5/GERD_source.csv", header=TRUE, stringsAsFactors=TRUE, check.names=FALSE)
basic<-read.csv("data/from_James/part5-international-july/aug5/basic_research.csv", header=TRUE, stringsAsFactors=TRUE, check.names=FALSE)
res.tot<-read.csv("data/from_James/part5-international-july/aug5/number_researchers_total.csv", header=TRUE, stringsAsFactors=TRUE, check.names=FALSE)


#pdf(file="figures/from_james//GERD_apr10.pdf", height=7, width=11)
pdf(file="figures/from_james/GERD_onlyfigure1a_apr10.pdf", height=7, width=11)
# png(file="figures/from_james//GERD_aug9.png", pointsize=20,height=900, width=1500)
## arrange data

## 1a. For GERD plots - total
gerd<-gather(gerd, YEAR, value, -Country, -panel)
gerd$Country<-revalue(gerd$Country, c("Taiwan (Chinese Taipei)"="Taiwan","Korea"="South Korea"))
...
gerd.source$Country<-revalue(gerd.source$Country, c("Taiwan (Chinese Taipei)"="Taiwan", "Korea"="South Korea"))
...
text(2006.8, 4.5, '(a) GERD Top Ten', cex=1.5, font=2)
...
axis(1, at=seq(2005, 2015,1),labels=seq(2005, 2015,1))
axis(2,  at=seq(1, 4.5, 0.5))
text(2005.5, 4.5, '(b) G8', cex=1.5, font=2)
